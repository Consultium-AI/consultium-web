...
/**
 * Oefenpagina-context voor Blok 10 week 5 · Casus C10 · DM2 symptomen, pathofysiologie en diagnostiek (oefenvragen-docx).
 */
const Blok10Week5CasusC10DmType2SymptomenPathofysiologieDiagnostiekDm2PracticeIntro = () => (
  <div className="max-w-3xl mx-auto mt-8 mb-10 md:mb-12">
    <div
      className="relative overflow-hidden rounded-2xl border border-indigo-200/80 dark:border-indigo-900/50
        bg-gradient-to-br from-indigo-50/90 via-white to-slate-50/70
        dark:from-indigo-950/35 dark:via-slate-900/80 dark:to-slate-950/40
    ...
    >
      ...
      <div className="relative px-6 py-6 sm:px-8 sm:py-7">
        ...
        <div className="flex flex-wrap gap-3">
          {[
            { Icon: Activity, label: 'Beweegrichtlijnen · intensiteit · bot- en spierkracht' },
            { Icon: HeartPulse, label: 'Insulineresistentie · prediabetes · symptomen' },
            { Icon: Droplets, label: 'Glucose · HbA1c · diagnostiek en behandelstreef' },
          ].map(({ Icon, label }) => (
            <span
              key={label}
...
export default Blok10Week5CasusC10DmType2SymptomenPathofysiologieDiagnostiekDm2PracticeIntro
