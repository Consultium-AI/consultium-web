...
/**
 * Oefenpagina-context voor Blok 5 week 7 · Casus 14 · LMO Wat is AI. Kleur: LMO = sky (zie practiceModuleLinkStyles).
 */
const Blok5Week7Casus14LmoWatIsAiPracticeIntro = () => (
  <div className="max-w-3xl mx-auto mt-8 mb-10 md:mb-12">
    ...
    >
      ...
      <div className="relative px-6 py-6 sm:px-8 sm:py-7">
        ...
        <p className="text-sm text-slate-600 dark:text-slate-400 mb-5">Wat is AI?</p>
        <div className="flex flex-wrap gap-3">
          {[
            { Icon: Sparkles, label: 'AI · machine learning · deep learning · generatieve AI' },
            { Icon: MessageSquare, label: 'Taalmodellen · ChatGPT · NotebookLM · beperkingen' },
            { Icon: Brain, label: 'FACT · overheid · zorg · werk · deepfakes' },
          ].map(({ Icon, label }) => (
            <span
              key={label}
...
export default Blok5Week7Casus14LmoWatIsAiPracticeIntro
