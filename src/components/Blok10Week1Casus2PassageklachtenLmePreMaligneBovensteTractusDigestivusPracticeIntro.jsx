import { Dna, Flame, Microscope } from 'lucide-react'

/**
 * Oefenpagina-context voor Blok 10 week 1 · Casus 2 · (Pre)maligne bovenste tractus digestivus (oefenvragen-docx).
 */
const Blok10Week1Casus2PassageklachtenLmePreMaligneBovensteTractusDigestivusPracticeIntro = () => (
    ...
    >
      ...
      <div className="relative px-6 py-6 sm:px-8 sm:py-7">
        ...
        <div className="flex flex-wrap gap-3">
          {[
            { Icon: Flame, label: 'Barrett · surveillance · endoscopische therapie' },
            { Icon: Microscope, label: 'Slokdarm · maag · premaligne cascades' },
            { Icon: Dna, label: 'Correa · HDGC · histologie-types' },
          ].map(({ Icon, label }) => (
            <span
              key={label}
...
export default Blok10Week1Casus2PassageklachtenLmePreMaligneBovensteTractusDigestivusPracticeIntro
