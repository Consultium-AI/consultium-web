...
/**
 * Oefenpagina-context voor Blok 5 week 5 · Casus 9 · LMO (positieve en negatieve selectie). Kleur: LMO = sky.
 */
const Blok5Week5Casus9LmoPositieveEnNegatieveSelectiePracticeIntro = () => (
    ...
    >
      ...
      <div className="relative px-6 py-6 sm:px-8 sm:py-7">
        ...
        <div className="flex flex-wrap gap-3">
          {[
            { Icon: GitBranch, label: 'Beenmerg · thymus · tolerantie' },
            { Icon: Shield, label: 'MHC · positieve en negatieve selectie' },
            { Icon: Layers, label: 'AIRE · Treg · perifere tolerantie' },
          ].map(({ Icon, label }) => (
            <span
              key={label}
...
export default Blok5Week5Casus9LmoPositieveEnNegatieveSelectiePracticeIntro
