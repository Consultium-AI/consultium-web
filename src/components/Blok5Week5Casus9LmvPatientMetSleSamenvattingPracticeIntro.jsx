import { Activity, HeartPulse, Microscope, Shield } from 'lucide-react'

/**
 * Oefenpagina-intro voor LMV Patiënt met SLE (oranje / LMV-kleur).
 */
const Blok5Week5Casus9LmvPatientMetSleSamenvattingPracticeIntro = () => (
    ...
    >
      ...
      <div className="relative px-5 py-4 sm:px-6 sm:py-5">
        <p className="text-xs font-semibold uppercase tracking-wider text-orange-900/85 dark:text-orange-300/90 mb-3">
          Casus 9 · Patiënt met auto-immuunziekte · LMV · Patiënt met SLE
        </p>
        <div className="flex flex-wrap gap-2 mb-4">
          {[
            { Icon: Shield, label: 'Auto-antistoffen · immuuncomplexen' },
            { Icon: Microscope, label: 'Diagnostiek · SLICC · ANA' },
            { Icon: Activity, label: 'Multisysteem · orgaanbetrokkenheid' },
            { Icon: HeartPulse, label: 'Behandeling · prognose' },
          ].map(({ Icon, label }) => (
            <span
              key={label}
...
export default Blok5Week5Casus9LmvPatientMetSleSamenvattingPracticeIntro
