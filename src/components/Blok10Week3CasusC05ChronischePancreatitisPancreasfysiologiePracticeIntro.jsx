import { Beaker, Droplets, Factory, GitCompare } from 'lucide-react'

/**
 * Oefenpagina-context voor Blok 10 week 3 · Casus C05 · Pancreasfysiologie (oefenvragen-docx).
 */
const Blok10Week3CasusC05ChronischePancreatitisPancreasfysiologiePracticeIntro = () => (
    ...
    >
      ...
      <div className="relative px-6 py-6 sm:px-8 sm:py-7">
        ...
        <div className="flex flex-wrap gap-3">
          {[
            { Icon: Factory, label: 'Acinus · ducten · afvoer naar het duodenum' },
            { Icon: Beaker, label: 'Pancreassap · enzymen · zymogenen' },
            { Icon: Droplets, label: 'Bicarbonaat · neutralisatie · mucosa' },
            { Icon: GitCompare, label: 'Cefale · maag · darmfase secretie' },
          ].map(({ Icon, label }) => (
            <span
              key={label}
...
export default Blok10Week3CasusC05ChronischePancreatitisPancreasfysiologiePracticeIntro
