import { Layers, Stethoscope, Table2 } from 'lucide-react'

/**
 * Oefenpagina-context voor Blok 5 week 7 · Casus 14 · LMO Implementatie in de dermatologische praktijk. Kleur: LMO = sky (zie practiceModuleLinkStyles).
 */
const Blok5Week7Casus14LmoImplementatieInDeDermatologischePraktijkPracticeIntro = () => (
    ...
    >
      ...
      <div className="relative px-6 py-6 sm:px-8 sm:py-7">
        <p className="text-xs font-semibold uppercase tracking-wider text-sky-800/90 dark:text-sky-300/90 mb-2">
          LMO · Casus 14 · AI in de zorg
        </p>
        <p className="text-sm text-slate-600 dark:text-slate-400 mb-5">Implementatie in de dermatologische praktijk</p>
        <div className="flex flex-wrap gap-3">
          {[
            { Icon: Table2, label: 'Algemene populatie · zorggebruik · overdiagnose · PPV' },
            { Icon: Stethoscope, label: 'Huisartsenpraktijk · triage · werkdiagnose · behandelplan' },
            { Icon: Layers, label: 'Integraal Zorgakkoord · implementatie · gebruiksgemak' },
          ].map(({ Icon, label }) => (
            <span
              key={label}
...
export default Blok5Week7Casus14LmoImplementatieInDeDermatologischePraktijkPracticeIntro
