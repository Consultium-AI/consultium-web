import { Microscope, Scissors, UsersRound } from 'lucide-react'

/**
 * Oefenpagina-context voor Blok 10 week 1 · Casus 2 · LMV Chirurgische behandeling bovenste tractus digestivus (oefenvragen-docx).
 */
const Blok10Week1Casus2PassageklachtenLmvChirurgischeBehandelingVanAandoeningenAanDeBovensteTractusDigestivusPracticeIntro =
  () => (
      ...
      >
        ...
        <div className="relative px-6 py-6 sm:px-8 sm:py-7">
          ...
          <div className="flex flex-wrap gap-3">
            {[
              { Icon: UsersRound, label: 'MDO · chirurgie · oncologie · beeldvorming' },
              { Icon: Scissors, label: 'Slokdarm- en maagchirurgie · reconstructie · FLOT' },
              { Icon: Microscope, label: 'Diagnostiek · laparoscopie · pathologie · follow-up' },
            ].map(({ Icon, label }) => (
              <span
                key={label}
...
export default Blok10Week1Casus2PassageklachtenLmvChirurgischeBehandelingVanAandoeningenAanDeBovensteTractusDigestivusPracticeIntro
