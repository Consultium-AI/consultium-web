...
/**
 * Oefenpagina-context voor Blok 10 week 1 · Casus 2 · Kindergerelateerde ziekten (oefenvragen-docx).
 */
const Blok10Week1Casus2PassageklachtenLmeKindergerelateerdeZiektenPracticeIntro = () => (
    ...
    >
      ...
      <div className="relative px-6 py-6 sm:px-8 sm:py-7">
        ...
        <div className="flex flex-wrap gap-3">
          {[
            { Icon: Baby, label: 'Pediatrische buikpijn · leeftijd · differentiaaldiagnose' },
            { Icon: Stethoscope, label: 'Acute en chronische klachten · Rome IV · IBD' },
            { Icon: ClipboardList, label: 'Functionele obstipatie · red flags · neonatale icterus' },
          ].map(({ Icon, label }) => (
            <span
              key={label}
...
export default Blok10Week1Casus2PassageklachtenLmeKindergerelateerdeZiektenPracticeIntro
