...
/**
 * Oefenpagina-context voor Blok 5 week 5 · Casus 9 · LMO (VO RA — klinische presentatie en immuunmechanismen). Kleur: LMO = sky.
 */
const Blok5Week5Casus9LmoVoorbereidingVoRaKlinischePresentatieEnImmuunmechanismenPracticeIntro = () => (
    ...
    >
      ...
      <div className="relative px-6 py-6 sm:px-8 sm:py-7">
        <p className="text-xs font-semibold uppercase tracking-wider text-sky-800/90 dark:text-sky-300/90 mb-2">
          LMO · Casus 9 · Patiënt met auto-immuunziekte
        </p>
        <p className="text-sm text-slate-600 dark:text-slate-400 mb-5">
          Klinische presentatie en immuunmechanismen (VOW RA)
        </p>
        <div className="flex flex-wrap gap-3">
          {[
            { Icon: Bone, label: 'Kraakbeen · synovium · bot' },
            { Icon: Stethoscope, label: 'Gewrichtsklachten · RA-patroon' },
            { Icon: Activity, label: 'Pannus · cytokinen · erosies' },
          ].map(({ Icon, label }) => (
            <span
              key={label}
...
export default Blok5Week5Casus9LmoVoorbereidingVoRaKlinischePresentatieEnImmuunmechanismenPracticeIntro
