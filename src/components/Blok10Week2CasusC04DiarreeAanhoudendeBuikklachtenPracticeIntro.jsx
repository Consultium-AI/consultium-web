...
/**
 * Oefenpagina-context voor Blok 10 week 2 · Casus C04 · Aanhoudende buikklachten (ALK, oefenvragen uit cursus-docx).
 */
const Blok10Week2CasusC04DiarreeAanhoudendeBuikklachtenPracticeIntro = () => (
    ...
    >
      ...
      <div className="relative px-6 py-6 sm:px-8 sm:py-7">
        ...
        <div className="flex flex-wrap gap-3">
          {[
            { Icon: ClipboardList, label: 'Epidemiologie ALK · huisarts en poli' },
            { Icon: Activity, label: 'Biopsychosociaal begrijpen · instandhoudende factoren' },
            { Icon: MessageCircle, label: 'Gesprek · verwachtingsmanagement · concreet stappenplan' },
          ].map(({ Icon, label }) => (
            <span
              key={label}
...
export default Blok10Week2CasusC04DiarreeAanhoudendeBuikklachtenPracticeIntro
