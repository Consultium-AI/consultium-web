...
/**
 * Oefenpagina-context voor Blok 5 week 8 · Casus 15 · LMO Voorbereiding VOW palliatieve zorg. Kleur: LMO = sky.
 */
const Blok5Week8Casus15LmoVoorbereidingVowPalliatieveZorgPracticeIntro = () => (
    ...
    >
      ...
      <div className="relative px-6 py-6 sm:px-8 sm:py-7">
        <p className="text-xs font-semibold uppercase tracking-wider text-sky-800/90 dark:text-sky-300/90 mb-2">
          LMO · Casus 15 · Kiezen tussen twee kwaden
        </p>
        <p className="text-sm text-slate-600 dark:text-slate-400 mb-5">Voorbereiding VOW palliatieve zorg</p>
        <div className="flex flex-wrap gap-3">
          {[
            { Icon: Sparkles, label: 'Kern van palliatieve zorg · startmoment · surprise question' },
            { Icon: HeartHandshake, label: 'Vier dimensies van lijden · autonomie · maatwerk' },
            { Icon: MessageCircle, label: 'Samenwerking · nazorg · onderzoek' },
          ].map(({ Icon, label }) => (
            <span
              key={label}
...
export default Blok5Week8Casus15LmoVoorbereidingVowPalliatieveZorgPracticeIntro
