import { BookOpen, Bug, FlaskConical } from 'lucide-react'

/**
 * Oefenpagina-context voor Blok 10 week 1 · Casus 1 · Pathofysiologie Helicobacter pylori — Kumar & Clark (oefenvragen-docx).
 */
const Blok10Week1Casus1MaagklachtenLmoKumarClarkPathofysiologieHPyloriPracticeIntro = () => (
    ...
    >
      ...
      <div className="relative px-6 py-6 sm:px-8 sm:py-7">
        ...
        <div className="flex flex-wrap gap-3">
          {[
            { Icon: BookOpen, label: 'Kumar & Clark · kolonisatie · maagwand' },
            { Icon: Bug, label: 'H. pylori · gastritis · ulcus · maligniteitsrisico' },
            { Icon: FlaskConical, label: 'Pathofysiologische keten · klinische relevantie' },
          ].map(({ Icon, label }) => (
            <span
              key={label}
...
export default Blok10Week1Casus1MaagklachtenLmoKumarClarkPathofysiologieHPyloriPracticeIntro
