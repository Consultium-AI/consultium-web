import { Apple, Baby, Stethoscope } from 'lucide-react'

/**
 * Oefenpagina-context voor Blok 10 week 1 · Casus 1 · Reflux bij kinderen (oefenvragen-docx).
 */
const Blok10Week1Casus1MaagklachtenRefluxBijKinderenPracticeIntro = () => (
    ...
    >
      ...
      <div className="relative px-6 py-6 sm:px-8 sm:py-7">
        ...
        <div className="flex flex-wrap gap-3">
          {[
            { Icon: Baby, label: 'GOR · GORZ · regurgitatie · ruminatie' },
            { Icon: Stethoscope, label: 'Anamnese · red flags · groei · eerste stap' },
            { Icon: Apple, label: 'Voeding · verdikken · CMA · PPI' },
          ].map(({ Icon, label }) => (
            <span
              key={label}
...
export default Blok10Week1Casus1MaagklachtenRefluxBijKinderenPracticeIntro
