...
/**
 * Oefenpagina-context voor Blok 10 week 5 · Casus C09 · Elke arts behandelt obesitas (oefenvragen-docx).
 */
const Blok10Week5CasusC09ObesitasElkeArtsBehandeltObesitasPracticeIntro = () => (
    ...
    >
      ...
      <div className="relative px-6 py-6 sm:px-8 sm:py-7">
        ...
        <div className="flex flex-wrap gap-3">
          {[
            { Icon: Scale, label: 'Overgewicht · BMI · energiebalans' },
            { Icon: HeartPulse, label: 'Metabool risico · comorbiditeit' },
            { Icon: Activity, label: 'Leefstijl · beweging · eerstelijns aanpak' },
          ].map(({ Icon, label }) => (
            <span
              key={label}
...
export default Blok10Week5CasusC09ObesitasElkeArtsBehandeltObesitasPracticeIntro
