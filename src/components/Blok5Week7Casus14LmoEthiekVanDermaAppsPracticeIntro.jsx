...
/**
 * Oefenpagina-context voor Blok 5 week 7 · Casus 14 · LMO Ethiek van derma-apps. Kleur: LMO = sky (zie practiceModuleLinkStyles).
 */
const Blok5Week7Casus14LmoEthiekVanDermaAppsPracticeIntro = () => (
  <div className="max-w-3xl mx-auto mt-8 mb-10 md:mb-12">
    ...
    >
      ...
      <div className="relative px-6 py-6 sm:px-8 sm:py-7">
        ...
        <p className="text-sm text-slate-600 dark:text-slate-400 mb-5">Ethiek van derma-apps</p>
        <div className="flex flex-wrap gap-3">
          {[
            { Icon: Scale, label: 'Autonomie · weldoen · niet-schaden · rechtvaardigheid' },
            { Icon: Shield, label: 'Privacy · beroepsgeheim · vertrouwen · regulering' },
            { Icon: Eye, label: 'Transparantie · verantwoordelijkheid · aansprakelijkheid' },
          ].map(({ Icon, label }) => (
            <span
              key={label}
...
export default Blok5Week7Casus14LmoEthiekVanDermaAppsPracticeIntro
