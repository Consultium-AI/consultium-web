import { Activity, GitBranch, Scissors, Stethoscope } from 'lucide-react'

/**
 * Oefenpagina-intro voor LME 38 (lymfeklierdissectie): casuscontext, geen examenvragen.
 */
const Blok5Week4Casus8LymfeklierdissectiePracticeIntro = () => (
    ...
    >
      ...
      <div className="relative px-5 py-4 sm:px-6 sm:py-5">
        <p className="text-xs font-semibold uppercase tracking-wider text-sky-900/85 dark:text-sky-300/90 mb-3">
          Casus 8 · Zwelling in de oksel · Lymfeklierdissectie
        </p>
        <div className="flex flex-wrap gap-2 mb-4">
          {[
            { Icon: Scissors, label: 'Chirurgie · dissectie' },
            { Icon: GitBranch, label: 'Sentinel node · N-status' },
            { Icon: Activity, label: 'Axillair · inguinaal · diep' },
            { Icon: Stethoscope, label: 'Complicaties · mammacarcinoom · melanoom' },
          ].map(({ Icon, label }) => (
            <span
              key={label}
...
export default Blok5Week4Casus8LymfeklierdissectiePracticeIntro
