import { Baby, Microscope, Wind } from 'lucide-react'

/**
 * Oefenpagina-context voor Blok 10 week 2 · Casus C04 · Malabsorptie (oefenvragen-docx).
 */
const Blok10Week2CasusC04DiarreeMalabsorptiePracticeIntro = () => (
    ...
    >
      ...
      <div className="relative px-6 py-6 sm:px-8 sm:py-7">
        ...
        <div className="flex flex-wrap gap-3">
          {[
            { Icon: Baby, label: 'Zuigeling · koemelkeiwitenteropathie · peuterdiarree' },
            { Icon: Microscope, label: 'Coeliakie · IgA-anti-tTG · totaal IgA' },
            { Icon: Wind, label: 'Cystic fibrosis · dF508 · DIOS · lactose-ademtest' },
          ].map(({ Icon, label }) => (
            <span
              key={label}
...
export default Blok10Week2CasusC04DiarreeMalabsorptiePracticeIntro
