...
/**
 * Oefenpagina-context voor Blok 10 week 1 · Casus 2 · Motiliteit van de bovenste tractus digestivus (oefenvragen-docx).
 */
const Blok10Week1Casus2PassageklachtenLmeMotiliteitVanDeBovensteTractusDigestivusPracticeIntro = () => (
    ...
    >
      ...
      <div className="relative px-6 py-6 sm:px-8 sm:py-7">
        ...
        <div className="flex flex-wrap gap-3">
          {[
            { Icon: HeartPulse, label: 'GERD · LES · reflux · PPI · diagnostiek' },
            { Icon: Stethoscope, label: 'Achalasie · HRM · EGJ · Chicago-classificatie' },
            { Icon: Activity, label: 'Gastroparese · functionele dyspepsie · Rome IV' },
          ].map(({ Icon, label }) => (
            <span
              key={label}
...
export default Blok10Week1Casus2PassageklachtenLmeMotiliteitVanDeBovensteTractusDigestivusPracticeIntro
