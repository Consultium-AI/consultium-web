...
/**
 * Oefenpagina-context voor Blok 5 week 6 · Casus 11 · LMO Infecties binnen de kinderoncologie. Kleur: LMO = sky.
 */
const Blok5Week5Casus11LmoInfectiesBinnenDeKinderoncologiePracticeIntro = () => (
  <div className="max-w-3xl mx-auto mt-8 mb-10 md:mb-12">
    ...
    >
      ...
      <div className="relative px-6 py-6 sm:px-8 sm:py-7">
        ...
        <p className="text-sm text-slate-600 dark:text-slate-400 mb-5">Infecties binnen de kinderoncologie</p>
        <div className="flex flex-wrap gap-3">
          {[
            { Icon: Shield, label: 'Afweer · opportunistisch vs banale verwekkers' },
            { Icon: Microscope, label: 'PCR · diagnostiek · profylaxe' },
            { Icon: Bug, label: 'Stamceltransplantatie · fase-afhankelijk risico' },
          ].map(({ Icon, label }) => (
            <span
              key={label}
...
export default Blok5Week5Casus11LmoInfectiesBinnenDeKinderoncologiePracticeIntro
