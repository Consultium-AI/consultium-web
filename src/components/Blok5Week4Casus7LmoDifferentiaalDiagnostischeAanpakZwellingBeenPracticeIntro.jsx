import { Footprints, GitBranch, Stethoscope } from 'lucide-react'

/**
 * Oefenpagina-context voor Blok 5 week 4 · Casus 7 · LMO (differentiaal beenzwelling). Kleur: LMO = sky.
 */
const Blok5Week4Casus7LmoDifferentiaalDiagnostischeAanpakZwellingBeenPracticeIntro = () => (
    ...
    >
      ...
      <div className="relative px-6 py-6 sm:px-8 sm:py-7">
        ...
        <p className="text-sm text-slate-600 dark:text-slate-400 mb-5">
          Differentiaal diagnostische aanpak van zwelling in het been
        </p>
        <div className="flex flex-wrap gap-3">
          {[
            { Icon: GitBranch, label: 'Unilateraal · bilateraal · acuut · chronisch' },
            { Icon: Footprints, label: 'Voeten · pitting · Stemmer' },
            { Icon: Stethoscope, label: 'Duplex · anamnese · liesbreuk' },
          ].map(({ Icon, label }) => (
            <span
              key={label}
...
export default Blok5Week4Casus7LmoDifferentiaalDiagnostischeAanpakZwellingBeenPracticeIntro
