import { Footprints, Hospital, Salad } from 'lucide-react'

/**
 * Oefenpagina-context voor Blok 10 week 5 · Casus C09 · Lichaamsbeweging (oefenvragen-docx).
 */
const Blok10Week5CasusC09ObesitasLichaamsbewegingPracticeIntro = () => (
    ...
    >
      ...
      <div className="relative px-6 py-6 sm:px-8 sm:py-7">
        ...
        <div className="flex flex-wrap gap-3">
          {[
            { Icon: Salad, label: 'Obesitas · bariatrische ingrepen · dumping · supplementen' },
            { Icon: Footprints, label: 'Beweging en leefregels na chirurgie' },
            { Icon: Hospital, label: 'Indicaties · contra-indicaties · complicaties' },
          ].map(({ Icon, label }) => (
            <span
              key={label}
...
export default Blok10Week5CasusC09ObesitasLichaamsbewegingPracticeIntro
