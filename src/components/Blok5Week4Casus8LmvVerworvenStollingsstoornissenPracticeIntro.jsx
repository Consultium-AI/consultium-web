import { Activity, Droplets, FlaskConical, Microscope } from 'lucide-react'

/**
 * Oefenpagina-intro voor LMV Verworven stollingsstoornissen (oranje / LMV-kleur).
 */
const Blok5Week4Casus8LmvVerworvenStollingsstoornissenPracticeIntro = () => (
    ...
    >
      ...
      <div className="relative px-5 py-4 sm:px-6 sm:py-5">
        <p className="text-xs font-semibold uppercase tracking-wider text-orange-900/85 dark:text-orange-300/90 mb-3">
          Casus 8 · Zwelling in de oksel · LMV · Verworven stollingsstoornissen
        </p>
        <div className="flex flex-wrap gap-2 mb-4">
          {[
            { Icon: Droplets, label: 'Primaire / secundaire hemostase' },
            { Icon: Activity, label: 'ITP · trombocytopenie' },
            { Icon: FlaskConical, label: 'Mengproef · Bethesda · FVIII' },
            { Icon: Microscope, label: 'Verworven VWD · vWF · multimeren' },
          ].map(({ Icon, label }) => (
            <span
              key={label}
        ...
        <p className="text-sm text-slate-600 dark:text-slate-400 leading-relaxed">
          Meerkeuzevragen en een open vraag met modelantwoord — antwoordopties zoals in je oefenmateriaal.
        </p>
      </div>
    </div>
  </div>
...
export default Blok5Week4Casus8LmvVerworvenStollingsstoornissenPracticeIntro
