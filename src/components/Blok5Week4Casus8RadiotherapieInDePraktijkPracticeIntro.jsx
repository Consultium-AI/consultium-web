import { Activity, Layers, Radio, Zap } from 'lucide-react'

/**
 * Oefenpagina-intro voor LME 40 (radiotherapie in de praktijk): casuscontext, geen examenvragen.
 */
const Blok5Week4Casus8RadiotherapieInDePraktijkPracticeIntro = () => (
  <div className="max-w-3xl mx-auto mb-8">
    <div
      className="relative overflow-hidden rounded-2xl border border-violet-200/80 dark:border-violet-900/50
        bg-gradient-to-br from-violet-50/90 via-white to-slate-50/80
        dark:from-violet-950/35 dark:via-slate-900/80 dark:to-slate-950/50
    ...
    >
      ...
      <div className="relative px-5 py-4 sm:px-6 sm:py-5">
        <p className="text-xs font-semibold uppercase tracking-wider text-violet-900/85 dark:text-violet-300/90 mb-3">
          Casus 8 · Zwelling in de oksel · Radiotherapie in de praktijk
        </p>
        <div className="flex flex-wrap gap-2 mb-4">
          {[
            { Icon: Zap, label: 'Gray · TCP · NTCP' },
            { Icon: Radio, label: 'Fractionering · 4 R’s' },
            { Icon: Activity, label: 'Acute / late toxiciteit' },
            { Icon: Layers, label: 'Therapeutische breedte' },
          ].map(({ Icon, label }) => (
            <span
              key={label}
...
export default Blok5Week4Casus8RadiotherapieInDePraktijkPracticeIntro
