    ...
    >
      ...
      <section id="intro" className="scroll-mt-24 mb-12">
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          <p>
            Hoe communiceren immuuncellen met elkaar en met andere cellen? Dit gebeurt via de <strong>signaalmoleculen van het immuunsysteem: cytokinen</strong>. Cytokinen zijn eiwitten die door immuuncellen en andere cellen worden geproduceerd en die de activiteit van doelwitcellen beÃ¯nvloeden.
          </p>
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm border-collapse">
              ...
              <tbody>
                <tr><td className="border border-slate-200 pl-3 py-2"><strong>Pleiotropie</strong></td><td className="border border-slate-200 pl-3 py-2">EÃ©n cytokine heeft effect op meerdere celtypen</td><td className="border border-slate-200 pl-3 py-2">IL-12 werkt op T-cellen Ã©n NK-cellen</td></tr>
                <tr><td className="border border-slate-200 pl-3 py-2"><strong>Redundantie</strong></td><td className="border border-slate-200 pl-3 py-2">Meerdere cytokinen hebben hetzelfde effect</td><td className="border border-slate-200 pl-3 py-2">TNF-Î± en IFN-Î³ stimuleren beide endotheelcellen</td></tr>
                ...
                <tr><td className="border border-slate-200 pl-3 py-2"><strong>Inhibitie</strong></td><td className="border border-slate-200 pl-3 py-2">EÃ©n cytokine remt het effect van een ander</td><td className="border border-slate-200 pl-3 py-2">IL-10 remt pro-inflammatoire cytokinen</td></tr>
              </tbody>
            </table>
          </div>
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          ...
          <div className="p-5 bg-rose-50 rounded-xl border-l-4 border-rose-400">
            ...
            <p className="text-rose-700 m-0">
              <strong>JAK-remmers</strong> grijpen in op deze route; ze remmen de fosforylering van STAT-eiwitten en onderbreken cytokinesignalering. Daardoor verminderen ze ontstekingsactiviteit bij auto-immuunziekten zoals reumatoÃ¯de artritis.
            </p>
          </div>
        </div>
      </section>
      ...
      <section id="pro-anti" className="scroll-mt-24 mb-12">
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          <p>
            Cytokinen kunnen worden ingedeeld naar hun effect op ontsteking. <strong>Pro-inflammatoire</strong> cytokinen (zoals TNF-Î±, IL-1, IL-6) bevorderen ontsteking; <strong>anti-inflammatoire</strong> cytokinen (zoals IL-10) remmen ontsteking.
          </p>
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div className="p-5 bg-red-50 rounded-xl border border-red-200">
              ...
              <p className="text-red-700 text-sm mb-2">
                Activatie endotheelcellen â†’ vasodilatatie, verhoogde permeabiliteit; inductie acute-fase-eiwitten in de lever; koorts; stimulatie macrofagen en andere immuuncellen.
              </p>
          ...
          <div className="p-5 bg-amber-50 rounded-xl border border-amber-200">
            ...
            <p className="text-amber-700 text-sm m-0">
              De indeling in pro- en anti-inflammatoir is een <strong>nuttige maar vereenvoudigde benadering</strong>. In werkelijkheid hangt het effect af van context: concentratie, timing, doelwitcel en combinatie met andere cytokinen. Cytokinen werken niet geÃ¯soleerd maar in complexe netwerken.
            </p>
          </div>
        </div>
      </section>
      ...
      <section id="netwerken" className="scroll-mt-24 mb-12">
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          <p>
            Cytokinen functioneren <strong>niet geÃ¯soleerd</strong> maar in complexe netwerken. Ze kunnen elkaars werking positief of negatief beÃ¯nvloeden.
          </p>
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          ...
          <div className="p-5 bg-rose-50 rounded-xl border-l-4 border-rose-400">
            ...
            <p className="text-rose-700 text-sm m-0">
              Bij sepsis zijn IL-6 en TNF-Î± vaak verhoogd. Deze cytokinen activeren endotheelcellen en veroorzaken <strong>vasodilatatie</strong> en <strong>verhoogde permeabiliteit</strong>, wat leidt tot een lage bloeddruk (hypotensie).
            </p>
          </div>
          ...
          <div className="p-5 bg-teal-50 rounded-xl border border-teal-200">
            ...
            <p className="text-teal-700 text-sm m-0">
              JAK-remmers worden toegepast bij reumatoÃ¯de artritis en andere auto-immuunziekten. Ze remmen de JAK-STAT-route, waardoor transcriptie van cytokine-afhankelijke genen wordt geremd en ontstekingsactiviteit afneemt.
            </p>
          </div>
      ...
      <section id="samenvatting" className="scroll-mt-24 mb-12">
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          <ul className="list-disc pl-6 space-y-2">
            <li>Cytokinen zijn signaalmoleculen van het immuunsysteem; ze binden aan receptoren en beÃ¯nvloeden celfunctie.</li>
            ...
            <li>JAK-STAT signalering: cytokine binding â†’ JAK-activatie â†’ STAT-fosforylering â†’ transcriptie in de kern.</li>
            ...
            <li>Klinisch: sepsis (hypotensie door TNF-Î±/IL-6), JAK-remmers bij auto-immuunziekten, IL-10 als anti-inflammatoir signaal.</li>
          </ul>
        </div>
      </section>
    </SummaryLayout>
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          ...
          <div className="p-5 bg-teal-50 rounded-xl border border-teal-200">
            ...
            <p className="text-teal-700 text-sm mb-2">
              Rinovirus, coronavirus, adenovirus, RSV, enterovirus, influenza, para-influenza. Epidemiologisch komen infecties vaak in clusters voor (gezin, crÃ¨che) en in dezelfde periode van het jaar.
            </p>
            <p className="text-teal-700 text-sm m-0">
              <strong>BacteriÃ«le verwekkers:</strong> Groep A-streptokokken (faryngitis), Staphylococcus aureus (conjunctivitis, rhinosinusitis, otitis), Chlamydia trachomatis (conjunctivitis). Adenovirus kan conjunctivitis, rhinitis, otitis Ã©n faryngitis veroorzaken.
            </p>
          </div>
        </div>
      </section>
      ...
      <section id="onderste" className="scroll-mt-24 mb-12">
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          ...
          <div className="p-5 bg-primary-50 rounded-xl border border-primary-200">
            ...
            <p className="text-primary-700 text-sm mb-2">
              <strong>Symptomen:</strong> neusverkoudheid, lichte koorts (~38Â°C), hoesten, piepende ademhaling (wheezen), tachypneu, oppervlakkige ademhaling, intrekkingen, slecht drinken, apneu's.
            </p>
            <p className="text-primary-700 text-sm m-0">
          ...
          <div className="p-5 bg-teal-50 rounded-xl border border-teal-200">
            ...
            <p className="text-teal-700 text-sm mb-2">
              <strong>Typische bacteriÃ«le verwekkers:</strong> Streptococcus pneumoniae, Haemophilus influenzae, Moraxella catarrhalis.
            </p>
            <p className="text-teal-700 text-sm mb-2">
            ...
            <p className="text-teal-700 text-sm m-0">
              <strong>Superinfectie:</strong> bij pneumonie door influenza is er risico op bacteriÃ«le superinfectie met Staphylococcus aureus.
            </p>
          </div>
        </div>
      </section>
      ...
      <section id="meningitis" className="scroll-mt-24 mb-12">
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          ...
          <div className="p-5 bg-primary-50 rounded-xl border border-primary-200">
            ...
            <p className="text-primary-700 text-sm m-0">
              Soms petechiÃ«n op de huid: <strong>niet-wegdrukbare vlekjes</strong> (kleur verandert niet bij strijken). Nekstijfheid: kin kan niet op de borst; bij bewegen hoofd naar borst worden de benen opgetrokken (Brudzinski). Bij 7â€“9 van de 10 kinderen met meningitis is nekstijfheid aanwezig.
            </p>
          </div>
      ...
      <section id="meningococ" className="scroll-mt-24 mb-12">
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          ...
          <div className="p-5 bg-red-50 rounded-xl border border-red-200">
            ...
            <p className="text-red-700 text-sm mb-2">
              PetechiÃ«n (kleine vlekjes) tot ecchymosen (samenvloeiende grote vlekken); op romp, extremiteiten en conjunctivae.
            </p>
            <p className="text-red-700 text-sm m-0">
              De snelheid waarmee petechiÃ«n, purpura en ecchymosen ontstaan na de eerste ziekteverschijnselen is een indicatie voor de ernst. <strong>Een kind met deze klachten moet heel snel in het ziekenhuis geholpen worden.</strong>
            </p>
          </div>
      ...
      <section id="overige" className="scroll-mt-24 mb-12">
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          ...
          <div className="p-5 bg-teal-50 rounded-xl border border-teal-200">
            ...
            <p className="text-teal-700 text-sm m-0">
              <strong>Klachten &lt;3 maanden:</strong> koorts, braken, lethargie, prikkelbaarheid. <strong>â‰¥3 maanden:</strong> preverbale fase: koorts vaak; verbale fase: frequent plassen, pijnlijke mictie. Buikpijn en flankpijn kunnen voorkomen.
            </p>
          </div>
        </div>
      </section>
      ...
      <section id="samenvatting" className="scroll-mt-24 mb-12">
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          <ul className="list-disc pl-6 space-y-2">
            ...
            <li>Meningitis: levensbedreigend; nekstijfheid, petechiÃ«n; bacterieel (meningococ, pneumococ, H. influenzae); restverschijnselen mogelijk.</li>
            <li>Meningococcenziekte: zeer ernstig; niet-wegdrukbare vlekken; snel ziekenhuis.</li>
            <li>UTI: vaak bacterieel; verwijzing kinderarts; symptomen variÃ«ren per leeftijd.</li>
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          ...
          <div className="p-5 bg-primary-50 rounded-xl border border-primary-200">
            ...
            <ul className="list-disc pl-6 space-y-2 text-primary-700 text-sm">
              <li><strong>Schade hypothalamus</strong> â€“ verstoorde thermoregulatie</li>
              <li><strong>Teveel aan schildklierhormoon</strong> â€“ verhoogd basaal metabolisme</li>
              <li><strong>Andere redenen voor pyrogenen</strong> â€“ auto-immuun/auto-inflammatoir; trombose, longembolie; maligniteit</li>
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            ...
            <div className="p-5 bg-teal-50 rounded-xl border border-teal-200">
              ...
              <p className="text-teal-700 text-sm mb-2">
                Verstoring aangeboren immuunsysteem â†’ spontane activering en productie van pro-inflammatoire cytokinen (IL-1, IL-6, TNF-Î±). Kenmerk: spontane inflammatie en koorts; <strong>geen autoantistoffen</strong> (aangeboren immuunsysteem).
              </p>
              <p className="text-teal-700 text-sm m-0">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div className="p-5 bg-rose-50 rounded-xl border border-rose-200">
              ...
              <p className="text-rose-700 text-sm m-0">
                Bloedvat verstopt door bloedstolsel. Door weefselschade komen pyrogenen vrij (IL-1, IL-6, IL-8, TNF-Î±).
              </p>
            </div>
            <div className="p-5 bg-indigo-50 rounded-xl border border-indigo-200">
              <h4 className="font-bold text-indigo-800 mb-2">Endocrien</h4>
              <p className="text-indigo-700 text-sm m-0">
                <strong>HyperthyreoÃ¯die:</strong> teveel schildklierhormoon (T3, T4) â†’ hoger basaal metabolisme â†’ hogere temperatuur.
              </p>
            </div>
          </div>
        </div>
      ...
      <section id="imade" className="scroll-mt-24 mb-12">
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          ...
          <div className="p-5 bg-primary-50 rounded-xl border border-primary-200">
            ...
            <ul className="list-disc pl-6 space-y-2 text-primary-700 text-sm">
              <li><strong>I</strong> â€“ Infectieus</li>
              <li><strong>M</strong> â€“ Maligniteit</li>
              <li><strong>A</strong> â€“ Auto-immuun/Auto-inflammatoir</li>
              <li><strong>D</strong> â€“ Drugs (medicatie)</li>
              <li><strong>E</strong> â€“ Everything else (m.n. endocrien en neurologisch)</li>
            </ul>
          </div>
        </div>
      </section>
      ...
      <section id="samenvatting" className="scroll-mt-24 mb-12">
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          <ul className="list-disc pl-6 space-y-2">
            ...
            <li>Pathways: niet-infectieuze mechanismen o.a. schade hypothalamus, hyperthyreoÃ¯die, pyrogenen (auto-immuun, trombose, maligniteit), overmatige prostaglandine productie.</li>
            <li>Oorzaken: auto-immuniteit (systemisch vs. orgaanspecifiek), auto-inflammatie (geen autoantistoffen, periodieke koortssyndromen), maligniteit, trombose/longembolie, endocrien (hyperthyreoÃ¯die).</li>
            <li>I MADE: Infectieus, Maligniteit, Auto-immuun/Auto-inflammatoir, Drugs, Everything else.</li>
            <li>Kawasaki: koorts â‰¥5 dagen + 4 van 5 criteria; vasculitis; 80% &lt;5 jaar; 25% coronair aneurysmata onbehandeld; behandeling IVIG, corticosteroiden, acetylsalicylzuur.</li>
          </ul>
        </div>
      </section>
    </SummaryLayout>
...
const OntstekingsmediatorenSummary = () => {
  const tableOfContents = [
    ...
    { id: 'categorieen', title: 'Moleculaire categorieÃ«n', icon: Layers },
  ...
  return (
    <SummaryLayout
      ...
      description="Van moleculaire categorieÃ«n tot plasma-cascades: overzicht van mediatoren van de acute ontstekingsreactie."
      caseLabel="Casus 4: Kind met koorts"
      tableOfContents={tableOfContents}
    ...
    >
      ...
      {/* Section 2: Moleculaire categorieÃ«n */}
      ...
      <section id="allergie" className="scroll-mt-24 mb-12">
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          <p>
            Bij acute allergische reacties is de tijd tussen contact met het allergeen en het optreden van symptomen (hoesten, niezen, huiduitslag, soms allergische shock) vaak niet meer dan Ã©Ã©n minuut.
          </p>
          
          <div className="p-5 bg-primary-50 rounded-xl border border-primary-200">
            <h4 className="font-bold text-primary-800 mb-2">Mestcellen</h4>
            <p className="text-primary-700 text-sm mb-2">
              <strong>Mestcellen</strong> spelen een essentiÃ«le rol. Ontstekingsmediatoren zoals histamine zijn al aangemaakt en opgeslagen in de <strong>granula</strong> van mestcellen.
            </p>
            <p className="text-primary-700 text-sm mb-2">
      ...
      <section id="radicalen" className="scroll-mt-24 mb-12">
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          <p>
            Bij contact met pathogenen reageren aangeboren immuuncellen snel door onder meer <strong>zuurstofradicalen</strong> (ROS) en <strong>stikstofradicalen</strong> (NO) te produceren. Het NADPH-oxidase-complex zet Oâ‚‚ om in <strong>superoxide (Oâ‚‚â€¢â»)</strong>. Superoxide dismutase vormt Hâ‚‚Oâ‚‚; katalase en glutathion-peroxidase breken Hâ‚‚Oâ‚‚ af. <strong>Myeloperoxidase</strong> produceert uit Hâ‚‚Oâ‚‚ + Clâ» de microbicide producten <strong>HOCl</strong> en <strong>OHâ€¢</strong>.
          </p>
          
          <p>
            <strong>iNOS</strong> (in macrofagen) zet L-arginine om in <strong>NOâ€¢</strong>. Superoxide en NOâ€¢ vormen niet-enzymatisch <strong>peroxynitriet (ONOOâ»)</strong> â€“ sterk microbicide. Zuurstofradicalen worden ook door mitochondriÃ«n gemaakt; bescherming via superoxide dismutase, katalase, glutathion-peroxidase en anti-oxidanten (vitamine E, C, A, bÃ¨tacaroteen) is essentieel.
          </p>
          
          <div className="p-5 bg-amber-50 rounded-xl border border-amber-200">
            <h4 className="font-bold text-amber-800 mb-2">Cellulaire schade door radicalen</h4>
            <p className="text-amber-700 text-sm mb-2">
              <strong>Lipide peroxidatie</strong> â†’ membraanschade â†’ lysis. <strong>Eiwit-modificatie</strong> â†’ onjuiste vouwing â†’ enzymdisfunctie. <strong>DNA-schade</strong> â†’ breuk â†’ apoptose.
            </p>
            <p className="text-amber-700 text-sm m-0">
              ROS bepalen de redox-status; ze activeren redox-sensoren en induceren genexpressie van anti-oxidatieve enzymen en cytokinen. Zuurstofradicalen activeren ook het <strong>NLRP3-inflammasoom</strong>, dat pro-IL-1Î² knipt waardoor IL-1Î² vrijkomt.
            </p>
          </div>
          ...
          <div className="p-5 bg-rose-50 rounded-xl border-l-4 border-rose-400">
            <h4 className="font-bold text-rose-800 mb-2 flex items-center gap-2">
              <Stethoscope className="w-4 h-4" />
              Primaire immunodeficiÃ«nties
            </h4>
            <p className="text-rose-700 text-sm mb-2">
              <strong>Chronische granulomateuze ziekte (CGD):</strong> defect in NADPH-oxidase â†’ verminderde oxidatieve burst â†’ granulomen.
            </p>
            <p className="text-rose-700 text-sm mb-2">
              <strong>ChÃ©diak-Higashi:</strong> mutatie LYST-gen â†’ verstoorde fusie lysosomen met fagosomen.
            </p>
            <p className="text-rose-700 text-sm m-0">
              <strong>LAD-1:</strong> defect integrine Î²2-keten (CD18) â†’ verstoorde adhesie leukocyten aan endotheel.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div className="p-5 bg-primary-50 rounded-xl border border-primary-200">
              ...
              <p className="text-primary-700 text-sm mb-2">
                Producten: <strong>lipoxinen</strong> (ontstekingsremmend), <strong>leukotrienen</strong> (chemotaxie, vasoconstrictie, â†‘ permeabiliteit).
              </p>
              <p className="text-primary-700 text-sm m-0">
            ...
            <div className="p-5 bg-teal-50 rounded-xl border border-teal-200">
              ...
              <p className="text-teal-700 text-sm mb-2">
                Producten: <strong>prostaglandinen</strong> (vaatverwijding, oedeemvorming, â†“ plaatjesaggregatie), <strong>tromboxaan TxAâ‚‚</strong> (vasoconstrictie, â†‘ plaatjesaggregatie).
              </p>
              <p className="text-teal-700 text-sm m-0">
                COX-1: constitutief actief in maag (bescherming). COX-2: geÃ¯nduceerd door ontsteking.
              </p>
            </div>
          </div>
        </div>
      ...
      <section id="ontstekingsremmers" className="scroll-mt-24 mb-12">
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          <div className="p-5 bg-primary-50 rounded-xl border border-primary-200">
            <h4 className="font-bold text-primary-800 mb-2">CorticosteroÃ¯den</h4>
            <p className="text-primary-700 text-sm mb-2">
              Remmen <strong>fosfolipase A2</strong> â†’ geen arachidonzuurvrijmaking. Ook: remming lymfocytenproliferatie (lymfocyten produceren TNF, IL-6, IFN-Î³) en blokkade van <strong>NF-ÎºB</strong>-activatie.
            </p>
            <p className="text-primary-700 text-sm m-0">
              NF-ÎºB is de primaire transcriptiefactor die in zowel aangeboren als adaptieve immuunresponsen wordt geactiveerd; NF-ÎºB stimuleert transcriptie van pro-inflammatoire cytokinen (IL-1, TNF, IL-6).
            </p>
          </div>
          ...
          <div className="p-5 bg-teal-50 rounded-xl border border-teal-200">
            ...
            <p className="text-teal-700 text-sm mb-2">
              Remmen <strong>cyclo-oxygenasen</strong> (COX-1 en COX-2) â†’ geen prostaglandinen en tromboxaan. Aselectieve remmers blokkeren ook maag-beschermende prostaglandinen (COX-1 in maag) â†’ risico op <strong>maagulcera</strong>.
            </p>
            <p className="text-teal-700 text-sm m-0">
              <strong>Selectieve COX-2-remmers</strong> (celecoxib, rofecoxib): minder maagulcera, maar verhoogd risico op <strong>hoge bloeddruk</strong> en <strong>stolsels</strong> (COX-1 blijft actief â†’ tromboxaan; endotheel produceert via COX-2 prostacycline dat vasodilatatie en anti-aggregatie geeft).
            </p>
          </div>
        </div>
      </section>
      ...
      <section id="acutefase" className="scroll-mt-24 mb-12">
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          ...
          <div className="p-5 bg-primary-50 rounded-xl border border-primary-200">
            ...
            <p className="text-primary-700 text-sm m-0">
              Cytokinen bereiken de hersenen â†’ prostaglandinen â†’ koorts en sickness behaviour. Beenmerg wordt gestimuleerd tot productie van monocyten en neutrofielen.
            </p>
          </div>
        </div>
      </section>
      ...
      <section id="plasma" className="scroll-mt-24 mb-12">
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          ...
          <div className="p-5 bg-primary-50 rounded-xl border border-primary-200">
            ...
            <p className="text-primary-700 text-sm mb-2">
              <strong>Kininecascade:</strong> Factor XIIa â†’ prekallikreÃ¯ne â†’ kallikreÃ¯ne â†’ kininogeen â†’ <strong>bradykinine</strong> (pijn, vaatverwijding, gladde spiercontractie).
            </p>
            <p className="text-primary-700 text-sm mb-2">
              <strong>Stollingscascade:</strong> Factor XIIa â†’ XI â†’ X â†’ protrombine â†’ trombine â†’ fibrinogeen â†’ fibrine.
            </p>
            <p className="text-primary-700 text-sm mb-2">
              <strong>Fibrinolytisch systeem:</strong> kallikreÃ¯ne activeert; plasminogeen â†’ plasmine â†’ fibrinedegradatieproducten (chemotaxie, vaatverwijding).
            </p>
            <p className="text-primary-700 text-sm m-0">
              <strong>Complementcascade:</strong> plasmine activeert; C3 â†’ C3a (chemotaxie, vaatverwijding).
            </p>
          </div>
          ...
          <div className="p-5 bg-teal-50 rounded-xl border border-teal-200">
            ...
            <p className="text-teal-700 text-sm mb-2">
              <strong>Lokaal â€“ fagocyten:</strong> ROS, cytokinen, chemokinen, prostaglandinen, leukotrienen, NO, lysosomale enzymen.
            </p>
            <p className="text-teal-700 text-sm mb-2">
              <strong>Lokaal â€“ mestcellen:</strong> histamine, serotonine.
            </p>
            <p className="text-teal-700 text-sm mb-2">
              <strong>Systemisch â€“ lever:</strong> stollingsfactoren, acuutfase-eiwitten, complementfactoren. <strong>Systemisch â€“ bijnierschors:</strong> cortisol.
            </p>
            <p className="text-teal-700 text-sm m-0">
              Cytokinen functioneren in netwerken; <strong>pleiotropie</strong> (Ã©Ã©n cytokine, meerdere effecten) en <strong>redundantie</strong> (meerdere cytokinen, zelfde effect) zijn sleutelbegrippen.
            </p>
          </div>
        </div>
      </section>
      ...
      <section id="samenvatting" className="scroll-mt-24 mb-12">
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          <ul className="list-disc pl-6 space-y-2">
            ...
            <li>Moleculaire categorieÃ«n: klein-moleculair (NO, ROS), aminozuur-derivaat (histamine, serotonine), lipide (leukotrienen, prostaglandinen, cortisol), eiwit (stollingsfactoren, cytokinen, complement, lysosomale enzymen, acuutfase-eiwitten).</li>
            ...
            <li>Radicalen: NADPH-oxidase; superoxide, Hâ‚‚Oâ‚‚, myeloperoxidase (HOCl); iNOS (NO); peroxynitriet; NLRP3-inflammasoom.</li>
            <li>Arachidonzuur: PLA2; lipoxygenasen (lipoxinen, leukotrienen); COX (prostaglandinen, tromboxaan).</li>
            <li>Ontstekingsremmers: corticosteroÃ¯den (PLA2, NF-ÎºB); NSAIDs (COX); selectieve COX-2-remmers (risico hypertensie, stolsels).</li>
  ...
  return (
    ...
    >
      ...
      <section id="intro" className="scroll-mt-24 mb-12">
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          <p>
            Na het doorlopen van deze module ben je in staat om thermoregulatie uit te leggen, de definitie van koorts te benoemen, de fysiologische functie van koorts te beschrijven en alarmsymptomen bij een patiÃ«nt met koorts te herkennen.
          </p>
      ...
      <section id="thermoregulatie" className="scroll-mt-24 mb-12">
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          <p>
            De gemiddelde lichaamstemperatuur van de mens is rond de <strong>37Â°C (98,6Â°F)</strong> om verschillende redenen: <strong>enzym efficiÃ«ntie</strong> (enzymen functioneren optimaal bij ~37Â°C), <strong>pathogeenverdediging</strong>, <strong>homeostase</strong> en <strong>evolutionaire aanpassing</strong>.
          </p>
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div className="p-5 bg-teal-50 rounded-xl border border-teal-200">
              ...
              <ul className="list-disc pl-6 space-y-1 text-teal-700 text-sm">
                ...
                <li>Ontspannen arrector pili-spieren (haren plat â†’ meer warmteafgifte)</li>
              </ul>
            </div>
            <div className="p-5 bg-amber-50 rounded-xl border border-amber-200">
      ...
      <section id="koorts" className="scroll-mt-24 mb-12">
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          <p>
            <strong>Koorts</strong> is een complexe fysiologische reactie op infectie, ontsteking of andere prikkels, gekenmerkt door een verhoging van de lichaamstemperatuur boven de normale waarde. Koorts wordt geÃ¯nitieerd door <strong>pyrogenen</strong>.
          </p>
          
          <div className="p-5 bg-primary-50 rounded-xl border border-primary-200">
            <h4 className="font-bold text-primary-800 mb-2">Zes stappen van het koortsmechanisme</h4>
            <ol className="list-decimal pl-6 space-y-2 text-primary-700 text-sm">
              <li><strong>Infectie of ontsteking:</strong> Pathogenen (bacteriÃ«n, virussen) of letsel/ziekte worden gedetecteerd.</li>
              <li><strong>Vrijgave van pyrogenen:</strong> Exogeen (LPS, toxines) of endogeen (IL-1, IL-6, TNF-Î± door macrofagen/monocyten).</li>
              <li><strong>Hypothalamische activatie:</strong> Cytokinen interageren met receptoren in de hypothalamus â†’ productie PGE2.</li>
              ...
              <li><strong>Onderhoud en beÃ«indiging:</strong> Hogere temperatuur tot oorzaak is opgelost; daarna setpoint omlaag â†’ vasodilatatie en zweten.</li>
            </ol>
          </div>
      ...
      <section id="hyperthermie" className="scroll-mt-24 mb-12">
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          ...
          <div className="p-5 bg-primary-50 rounded-xl border border-primary-200">
            ...
            <p className="text-primary-700 text-sm mb-2">
              Koorts maakt de afweer efficiÃ«nter: betere motiliteit en activiteit van leukocyten, stimulatie van interferonproductie en T-celactivatie. De hogere temperatuur remt groei/deling van veel infectieuze verwekkers.
            </p>
            <p className="text-primary-700 text-sm m-0">
      ...
      <section id="samenvatting" className="scroll-mt-24 mb-12">
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          <ul className="list-disc pl-6 space-y-2">
            ...
            <li>Koorts: fysiologische reactie op infectie/ontsteking; pyrogenen (exogeen/endogeen) â†’ hypothalamus â†’ PGE2 (COX) â†’ verhoogd setpoint.</li>
  ...
  return (
    ...
    >
      ...
      <section id="intro" className="scroll-mt-24 mb-12">
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          <p>
            Na deze module kun je beredeneren welk micro-organisme(n) de meest waarschijnlijke ziekteveroorzaker(s) is/zijn bij een patiÃ«nt met luchtwegklachten, in relatie tot klachtenpatroon, epidemiologische gegevens en aanvullende diagnostiek.
          </p>
      ...
      <section id="microbioom" className="scroll-mt-24 mb-12">
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          ...
          <div className="p-5 bg-teal-50 rounded-xl border border-teal-200">
            ...
            <p className="text-teal-700 text-sm mb-2">
              Klaring door hoesten, longmacrofagen, trilling van respiratoire cilia en antimicrobiÃ«le werking van alveolaire surfactant dragen bij aan de dynamiek van het microbioom.
            </p>
            <p className="text-teal-700 text-sm m-0">
              Bij aandoeningen zoals <strong>COPD</strong> en <strong>cystic fibrosis</strong> kunnen zowel concentratie als samenstelling van de microbiota verschuiven (hogere dichtheid, andere bacteriÃ«n zoals P. aeruginosa, S. aureus, Haemophilus).
            </p>
          </div>
        </div>
      </section>
      ...
      <section id="cap" className="scroll-mt-24 mb-12">
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          ...
          <div className="p-5 bg-primary-50 rounded-xl border border-primary-200">
            ...
            <p className="text-primary-700 text-sm m-0">
              Microbiologische en moleculaire onderzoeken (kweek, antigeentesten, PCR) kunnen de verwekker vaststellen; de diagnose kan doorgaans vÃ³Ã³r uitslag worden gesteld.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div className="p-5 bg-emerald-50 rounded-xl border border-emerald-200">
              ...
              <ul className="list-disc pl-6 space-y-1 text-emerald-700 text-sm">
                ...
                <li>Microaerofiele bacteriÃ«n en anaeroben (aspiratie)</li>
              </ul>
            </div>
            <div className="p-5 bg-amber-50 rounded-xl border border-amber-200">
      ...
      <section id="pneumokok" className="scroll-mt-24 mb-12">
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          <p>
            <strong>Streptococcus pneumoniae</strong> (pneumokok) is wereldwijd de meest voorkomende typische verwekker van CAP. Van oudsher verantwoordelijk voor &gt;60% van CAP; tegenwoordig 10-30% wereldwijd. In Nederland: 20-30% van non-invasieve pneumonieÃ«n (~7500 opnames/jaar, waarvan 5500 â‰¥60 jaar).
          </p>
          ...
          <div className="p-5 bg-primary-50 rounded-xl border border-primary-200">
            ...
            <p className="text-primary-700 text-sm m-0">
              <strong>Diagnostiek:</strong> Sputumkweek (sensitiviteit 29-94%; afname vÃ³Ã³r antibiotica). Pneumokokken antigeentest in urine: sensitiviteit 65-80%, specificiteit 97-100%; nadeel: antigeen weken detecteerbaar; niet aanbevolen bij jonge kinderen (frequente dragerschap â†’ vals-positief).
            </p>
          </div>
          ...
          <div className="p-5 bg-teal-50 rounded-xl border border-teal-200">
            ...
            <p className="text-teal-700 text-sm m-0">
              <strong>Risicogroep:</strong> HIV-patiÃ«nten hebben verhoogd risico op invasieve pneumokokkenziekte; vaccinatie geadviseerd.
            </p>
          </div>
        </div>
      </section>
      ...
      <section id="haemophilus" className="scroll-mt-24 mb-12">
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          <p>
            <strong>H. influenzae</strong> is gÃ©Ã©n verwekker van griep (influenzavirus); het is een bacterie. Ontdekt in 1892 door Pfeiffer; pas in de jaren 1930 bleek het influenzavirus de griep te veroorzaken. Belangrijke typische verwekker van CAP.
          </p>
          ...
          <div className="p-5 bg-primary-50 rounded-xl border border-primary-200">
            ...
            <p className="text-primary-700 text-sm m-0">
              Belangrijke oorzaak van longontsteking bij volwassenen, vooral ouderen en bij COPD of immuundeficiÃ«nties. Klinisch niet te onderscheiden van andere typische verwekkers. <strong>COPD-exacerbaties:</strong> H. influenzae is een van de meest voorkomende bacteriÃ«le oorzaken.
            </p>
          </div>
          ...
          <div className="p-5 bg-rose-50 rounded-xl border-l-4 border-rose-400">
            ...
            <p className="text-rose-700 text-sm mb-2">
              Hib-manifestaties: meningitis (50%), epiglottitis (17%), pneumonie (15%), septische artritis (8%), cellulitis/erysipelas (6%), osteomyelitis (2%), bacteriÃ«mie (2%).
            </p>
            <p className="text-rose-700 text-sm m-0">
      ...
      <section id="atypisch" className="scroll-mt-24 mb-12">
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          ...
          <div className="p-5 bg-amber-50 rounded-xl border border-amber-200">
            ...
            <p className="text-amber-700 text-sm m-0">
              Recent verblijf buitenshuis (vakantiewoning, douches, airco), achteruitgang na start beta-lactam (amoxicillin) â†’ denk aan <strong>Legionella pneumophila</strong>. Milde presentatie met geleidelijk begin, "walking pneumonia" â†’ denk aan <strong>Mycoplasma pneumoniae</strong>.
            </p>
          </div>
        </div>
      </section>
      ...
      <section id="legionella" className="scroll-mt-24 mb-12">
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          <p>
            <strong>Legionella spp.</strong> zijn gramnegatieve, aerobe, niet-sporevormende, ongekapselde staven; kweek alleen op speciaal selectief medium. L. pneumophila: 15 serogroepen; serogroep 1 veroorzaakt &gt;80% van legionellapneumonieÃ«n in Nederland (&gt;90% door L. pneumophila).
          </p>
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div className="p-5 bg-primary-50 rounded-xl border border-primary-200">
              ...
              <p className="text-primary-700 text-sm mb-2">
                Klinisch niet te onderscheiden van andere pneumonieÃ«n; vaak ziekenhuis- en IC-opname. Droge hoest met pijn op de borst. Extrapulmonaal: neuropsychologisch (hoofdpijn, lethargie, verwardheid) 60%, diarree 25%, misselijkheid/braken 20%.
              </p>
              <p className="text-primary-700 text-sm m-0">
            ...
            <div className="p-5 bg-teal-50 rounded-xl border border-teal-200">
              ...
              <p className="text-teal-700 text-sm mb-2">
                Legionella in oppervlaktewater en bodem. Vermenigvuldiging 20-45Â°C; overleving &lt;20Â°C (geen groei); &gt;50Â°C niet overleefbaar. Transmissie via <strong>wateraerosolen</strong> (inhalatie); ook aspiratie van drinkwater.
              </p>
              <p className="text-teal-700 text-sm m-0">
                Bronnen: douches, sauna's, koeltorens, whirlpools, luchtbevochtigers, ventilatie. Meldingsplicht: arts â†’ GGD â†’ RIVM. Aantal meldingen in NL 2013-2022 +13%; weersomstandigheden spelen een rol.
              </p>
            </div>
          </div>
        </div>
      ...
      <section id="mycoplasma" className="scroll-mt-24 mb-12">
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          <p>
            Mycoplasmata zijn de kleinste vrijlevende bacteriÃ«n (~0,1-0,2 Ã— 1-2 Âµm); <strong>geen celwand</strong>, alleen vervormbaar plasmamembraan. Geen Gram-kleuring mogelijk; beta-lactam antibiotica werken niet. M. pneumoniae koloniseert vooral de luchtwegen en veroorzaakt "atypische" pneumonie.
          </p>
      ...
      <section id="samenvatting" className="scroll-mt-24 mb-12">
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          <ul className="list-disc pl-6 space-y-2">
            ...
            <li>H. influenzae: gÃ©Ã©n griep; gramnegatieve coccobacillus; COPD-exacerbaties; Hib-vaccin sinds 1993.</li>
            <li>Legionella: wateraerosolen; 20-45Â°C; urine-antigeentest; extrapulmonale symptomen.</li>
  ...
  return (
    ...
    >
      ...
      <section id="indicatie" className="scroll-mt-24 mb-12">
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          <p>
            De indicatie voor behandeling bij lagere luchtweginfecties hangt af van de <strong>ernst van de klachten</strong> en het <strong>risico op bepaalde verwekkers</strong>. In de anamnese moet je uitvinden of je empirisch een bacteriÃ«le oorzaak van pneumonie wilt behandelen en of de empirische keuze van antibiotica (zoals in de richtlijn) voor jouw patiÃ«nt voldoende is.
          </p>
          ...
          <div className="p-5 bg-rose-50 rounded-xl border-l-4 border-rose-400">
            ...
            <p className="text-rose-700 text-sm m-0">
              PatiÃ«nten met kans op een bijzondere (atypische) verwekker moeten mogelijk anders worden behandeld. Wees hierop bedacht.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm border-collapse">
              ...
              <tbody>
                <tr><td className="border border-slate-200 pl-3 py-2">Eerdere behandeling infectie afgelopen jaar?</td><td className="border border-slate-200 pl-3 py-2">Resistente bacteriÃ«n</td></tr>
                ...
                <tr><td className="border border-slate-200 pl-3 py-2">Immuungecompromitteerde patiÃ«nt?</td><td className="border border-slate-200 pl-3 py-2">Opportunistische verwekker</td></tr>
          ...
          <div className="p-5 bg-primary-50 rounded-xl border border-primary-200">
            ...
            <ul className="list-disc pl-6 space-y-1 text-primary-700 text-sm mb-2">
              ...
              <li>Ernstige symptomen: koorts, dyspneu, piepen, stridor, hemoptoÃ«, pijn borstkas (bij ademhaling)</li>
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div className="p-5 bg-amber-50 rounded-xl border border-amber-200">
              ...
              <p className="text-amber-700 text-sm m-0">
                <strong>Comorbiditeit:</strong> ernstige hart-/longaandoeningen, diabetes mellitus (vooral bij insulinegebruik), neurologische aandoeningen, lever-/nierinsufficiÃ«ntie, sterk verminderde afweer, (ex-)prematuriteit &lt;37 weken.
              </p>
            </div>
            <div className="p-5 bg-teal-50 rounded-xl border border-teal-200">
              <h4 className="font-bold text-teal-800 mb-2">Risicofactoren atypische verwekker</h4>
              <p className="text-teal-700 text-sm mb-2">
                Seizoensgebonden verheffing (Mycoplasma), reisanamnese (Legionella), diercontact (Coxiella burnetii, Chlamydia psittaci). Bij atypische verwekker slaat therapie mogelijk niet aan â†’ evalueer na 2 dagen.
              </p>
              <p className="text-teal-700 text-sm m-0">
            ...
            <table className="w-full text-sm border-collapse">
              <thead>
                <tr className="bg-slate-100">
                  ...
                  <th className="border border-slate-200 pl-3 py-2 text-left font-bold">PatiÃ«nt</th>
              ...
              <tbody>
                <tr><td className="border border-slate-200 pl-3 py-2">Pneumonie</td><td className="border border-slate-200 pl-3 py-2">Volwassenen, kinderen â‰¥37 kg</td><td className="border border-slate-200 pl-3 py-2">Amoxicilline 3Ã—500 mg, 5 dagen</td><td className="border border-slate-200 pl-3 py-2">Doxycycline of azitromycine (zwangeren)</td></tr>
                <tr><td className="border border-slate-200 pl-3 py-2">Pneumonie</td><td className="border border-slate-200 pl-3 py-2">Kinderen &lt;37 kg (&gt;1 mnd)</td><td className="border border-slate-200 pl-3 py-2">Amoxicilline 40 mg/kg 3Ã—, 5 dagen</td><td className="border border-slate-200 pl-3 py-2">Azitromycine 10 mg/kg 1Ã—, 3 dagen</td></tr>
                <tr><td className="border border-slate-200 pl-3 py-2">Aspiratie-pneumonie</td><td className="border border-slate-200 pl-3 py-2">Volwassenen</td><td className="border border-slate-200 pl-3 py-2">Amoxicilline/clavulaanzuur 3Ã—500/125 mg, 7 dagen</td><td className="border border-slate-200 pl-3 py-2">Clindamycine 3Ã—600 mg, 7 dagen</td></tr>
              </tbody>
            </table>
          </div>
        </div>
      ...
      <section id="verwijzing" className="scroll-mt-24 mb-12">
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          ...
          <div className="p-5 bg-primary-50 rounded-xl border border-primary-200">
            ...
            <p className="text-primary-700 text-sm mb-2">
              Confusion, Ureum &gt;7 mmol/l, Respiratory rate â‰¥30/min, Bloeddruk (SBP &lt;90 of DBP â‰¤60), Leeftijd â‰¥65 jaar. Elk criterium = 1 punt.
            </p>
            <ul className="list-disc pl-6 space-y-1 text-primary-700 text-sm mb-2">
              <li><strong>0-1 punt:</strong> lage mortaliteit (~1,5%) â†’ thuisbehandeling</li>
              <li><strong>2 punten:</strong> intermediaire mortaliteit (~9%) â†’ ziekenhuisbehandeling overwegen</li>
              <li><strong>3+ punten:</strong> hoge mortaliteit (~22%) â†’ ziekenhuisopname; bij 4-5 overwegen IC</li>
            </ul>
          </div>
      ...
      <section id="thuis" className="scroll-mt-24 mb-12">
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          <p>
            Bij thuisbehandeling is het belangrijk dat de patiÃ«nt of verzorgers goed geÃ¯nstrueerd worden. <strong>Plotseling bloed ophoesten</strong> is een nieuwe klacht die aanleiding geeft tot opnieuw contact; kan wijzen op andere verwekker of groter risico op ernstiger beloop.
          </p>
          ...
          <div className="p-5 bg-primary-50 rounded-xl border border-primary-200">
            ...
            <ul className="list-disc pl-6 space-y-2 text-primary-700 text-sm">
              ...
              <li>Laat patiÃ«nt contact opnemen als 48-72 uur na start antibiotica klachten onvoldoende verminderen.</li>
              <li>Instrueer contact bij: toenemende klachten/achteruitgang, (toename) kortademigheid of piepen, terugkerende koorts, pijn op de borst, hemoptoÃ«.</li>
      ...
      <section id="complicatie" className="scroll-mt-24 mb-12">
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          ...
          <div className="p-5 bg-primary-50 rounded-xl border border-primary-200">
            ...
            <p className="text-primary-700 text-sm mb-2">
              Bij ~40% van bacteriÃ«le pneumonie wordt rÃ¶ntgenologisch pleuravocht gezien. Meestal ongecompliceerd; verdwijnt met antibiotica. In 5-10% gecompliceerd (loketvorming); bij uitstel drainage â†’ empyeem.
            </p>
            <p className="text-primary-700 text-sm mb-2">
              Snel detecteren en evalueren van pleuravochtophoping is belangrijk (impact morbiditeit/sterfte). <strong>Enige absolute indicatie voor drainage:</strong> pus (bacteriÃ«n + neutrofielen) in pleuraholte.
            </p>
            <p className="text-primary-700 text-sm m-0">
      ...
      <section id="samenvatting" className="scroll-mt-24 mb-12">
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          <ul className="list-disc pl-6 space-y-2">
            ...
            <li>Risicofactoren ernstig beloop: leeftijd (&lt;3 mnd, &gt;75 jr), comorbiditeit (DM, hart-long, neuro, lever/nier, immunodeficiÃ«ntie, prematuriteit).</li>
            <li>Eerstekeus pneumonie: amoxicilline; bij onvoldoende effect na 2 dagen â†’ doxycycline/azitromycine.</li>
            <li>CURB-65: 0-1 thuis; 2 ziekenhuis; 3+ ernstig/ICU.</li>
            <li>Thuisbehandeling: instructies; contact bij alarmsymptomen (hemoptoÃ«, verslechtering, 48-72u geen verbetering).</li>
  ...
  return (
    ...
    >
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm border-collapse">
              ...
              <tbody>
                <tr><td className="border border-slate-200 pl-3 py-2">Bloed â†’ lymfeklier</td><td className="border border-slate-200 pl-3 py-2">HEV (95%) of afferente lymfe (5%)</td></tr>
                <tr><td className="border border-slate-200 pl-3 py-2">Lymfeklier â†’ bloed</td><td className="border border-slate-200 pl-3 py-2">Efferente lymfe â†’ ductus thoracicus</td></tr>
                <tr><td className="border border-slate-200 pl-3 py-2">Bloed â†’ milt</td><td className="border border-slate-200 pl-3 py-2">Direct uit bloed</td></tr>
              </tbody>
            </table>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div className="p-5 bg-indigo-50 rounded-xl border border-indigo-200">
              ...
              <p className="text-indigo-700 text-sm mb-2">
                Ontstaan in beenmerg â†’ naÃ¯eve B-cellen in bloed â†’ via HEV of afferente lymfe in lymfeklier â†’ follikels (outer cortex). Geactiveerd door antigeenherkenning + CD4+ T-celhulp â†’ plasmacel of B-geheugencel.
              </p>
              <p className="text-indigo-700 text-sm mb-2">
            ...
            <div className="p-5 bg-purple-50 rounded-xl border border-purple-200">
              ...
              <p className="text-purple-700 text-sm mb-2">
                Voorlopers in beenmerg â†’ uitrijping tot naÃ¯eve T-cel in <strong>thymus</strong> â†’ via bloed en HEV in lymfeklier â†’ paracortex (binnenste schors).
              </p>
              <p className="text-purple-700 text-sm m-0">
                Geactiveerd door DC â†’ effector-T-cellen (homen naar ontsteking) of geheugen-T-cellen (recirculeren).
              </p>
            </div>
          </div>
        </div>
      ...
      <section id="transmigratie-hev" className="scroll-mt-24 mb-12">
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          ...
          <div className="p-5 bg-rose-50 rounded-xl border-l-4 border-rose-400">
            ...
            <p className="text-rose-700 text-sm m-0">
              HEV-endotheel afwijkend van normaal venule-endotheel: cellen zijn <strong>hoger</strong> en bevatten <strong>meer cytoplasma</strong> (gevolg van endotheelactivatie). Hoog endotheel veroorzaakt wervelingen in de bloedstroom â†’ lymfocyten botsen vaker tegen de wand en blijven makkelijker plakken.
            </p>
          </div>
          ...
          <div className="p-5 bg-primary-50 rounded-xl border border-primary-200">
            ...
            <ul className="list-disc pl-6 space-y-1 text-primary-700 text-sm">
              <li>L-selectine (lymfocyt) â†’ GlyCAM-1</li>
              <li>CCR7 (lymfocyt) â†’ CCL19</li>
              <li>LFA-1/CD11a (lymfocyt) â†’ ICAM-1</li>
            </ul>
      ...
      <section id="homing" className="scroll-mt-24 mb-12">
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          <p>
            NaÃ¯eve lymfocyten 'homen' naar een bepaalde lymfeklier. Bij dit proces zijn verschillende adhesiemoleculen op de lymfocyten en op het endotheel van de HEV betrokken. In de lymfeklier bewegen T- en B-lymfocyten onder invloed van chemokinen naar hun eigen gebieden.
          </p>
          ...
          <div className="p-5 bg-slate-50 rounded-xl border-l-4 border-primary-400">
            ...
            <ol className="list-decimal pl-6 space-y-2 text-slate-600">
              ...
              <li><strong>Activatie en binding</strong>: chemokinen activeren integrinen; LFA-1 bindt aan ICAM-1 â†’ stevige adhesie</li>
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          ...
          <div className="p-5 bg-amber-50 rounded-xl border border-amber-200">
            ...
            <ol className="list-decimal pl-6 space-y-1 text-amber-700 text-sm mb-2">
              <li><strong>Rolling</strong>: selectinen op endotheel + selectine-liganden op leukocyten â†’ zwakke, reversibele binding</li>
      ...
      <section id="samenvatting" className="scroll-mt-24 mb-12">
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          <ul className="list-disc pl-6 space-y-2">
            <li>Lymfocyten circuleren: bloed â†’ HEV/afferente lymfe â†’ lymfeklier â†’ efferente lymfe â†’ ductus thoracicus â†’ bloed.</li>
            <li>B-cellen: beenmerg â†’ bloed â†’ lymfeklier (follikels); activatie door antigeen + CD4+ T-celhulp â†’ plasmacel of B-geheugencel.</li>
            <li>T-cellen: beenmerg â†’ thymus (uitrijping) â†’ paracortex lymfeklier; activatie door DC â†’ effector of geheugen.</li>
            ...
            <li>Transmigratie: rollen â†’ activatie en binding â†’ diapedese. Chemokinen activeren integrinen.</li>
            <li>Naar ontsteking: rolling â†’ chemokine signaling â†’ firm adhesion â†’ transmigratie. Sialyl-Lewis-X (granulocyten/monocyten), E- en P-selectine. Neutrofielen eerst bij acute ontsteking.</li>
          </ul>
        </div>
      </section>
    </SummaryLayout>
...
const InfectieuzeLymfadenopathieSummary = () => {
  ...
  return (
    <SummaryLayout
      title="Infectieuze lymfadenopathie â€“ tweede lijn"
    ...
    >
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div className="p-5 bg-amber-50 rounded-xl border border-amber-200">
              ...
              <ul className="list-disc pl-6 space-y-1 text-amber-700 text-sm">
                ...
                <li>Overige (sarcoÃ¯dose, amyloÃ¯dose)</li>
              </ul>
            </div>
            <div className="p-5 bg-indigo-50 rounded-xl border border-indigo-200">
          ...
          <div className="p-5 bg-slate-50 rounded-xl border-l-4 border-primary-400">
            ...
            <ul className="list-disc pl-6 space-y-1 text-slate-600 text-sm">
              ...
              <li><strong>ZoÃ¶nose:</strong> toxoplasmose, histoplasmose</li>
            </ul>
          </div>
        </div>
      </section>
      ...
      <section id="ebv" className="scroll-mt-24 mb-12">
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          ...
          <div className="p-5 bg-rose-50 rounded-xl border-l-4 border-rose-400">
            ...
            <p className="text-rose-700 text-sm mb-2">
              Neurologisch (myelitis transversa, nervus facialisparese, cerebellitis), rash na amoxicilline (EBV-geÃ¯nduceerd), hemolytische anemie. Zeldzaam: hemofagocytair syndroom, miltruptuur.
            </p>
            <p className="text-rose-700 text-sm m-0">
      ...
      <section id="toxoplasmose" className="scroll-mt-24 mb-12">
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          <p>
            Toxoplasmose is een <strong>zoÃ¶nose</strong>. Alleen katten kunnen oÃ¶cysten in het milieu brengen. Seroprevalentie Nederland ~30%.
          </p>
          
          <div className="p-5 bg-primary-50 rounded-xl border border-primary-200">
            <h4 className="font-bold text-primary-800 mb-2">Transmissie</h4>
            <ul className="list-disc pl-6 space-y-1 text-primary-700 text-sm">
              <li>Kattenbak, tuin, gecontamineerde groenten/fruit (oÃ¶cysten)</li>
              <li>Ongekookt/rauw vlees (weefselcysten met bradyzoÃ¯eten)</li>
              <li>Bloed- of orgaantransplantatie (tachyzoÃ¯eten)</li>
              <li>Congenitaal (primo-infectie zwangere â†’ foetus)</li>
            </ul>
          </div>
          ...
          <div className="p-5 bg-teal-50 rounded-xl border border-teal-200">
            ...
            <p className="text-teal-700 text-sm mb-2">
              80â€“90% postnataal asymptomatisch. Bij max. 20%: niet-pijnlijke cervicale lymfadenopathie (1â€“3 weken na besmetting), griepachtige klachten, splenomegalie. Symptomen kunnen maanden aanhouden.
            </p>
            <p className="text-teal-700 text-sm mb-2">
      ...
      <section id="kattenkrabziekte" className="scroll-mt-24 mb-12">
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          ...
          <div className="p-5 bg-primary-50 rounded-xl border border-primary-200">
            ...
            <ul className="list-disc pl-6 space-y-1 text-primary-700 text-sm">
              <li>Na 3â€“6 dagen: vesiculaire laesie (primair), geneest na enkele dagen</li>
              <li>1/3: lichte koorts, hoofdpijn, malaise</li>
              <li>Na 1â€“2 weken: regionale lymfadenitis (hals, oksel, lies); klieren groot, zacht, pijnlijk; soms draineren</li>
          ...
          <div className="p-5 bg-teal-50 rounded-xl border border-teal-200">
            ...
            <p className="text-teal-700 text-sm mb-2">
              <strong>Diagnostiek:</strong> PCR op pus of biopt (meest gevoelig). Bartonella zilverimpregnatie in preparaat/kweek alleen in acute fase. Serologie beperkt (IgG bij gezonde personen; IgM/IgG sensitiviteit 50â€“65%).
            </p>
            <p className="text-teal-700 text-sm m-0">
      ...
      <section id="tuberculose" className="scroll-mt-24 mb-12">
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          <p>
            TB veroorzaakt 43% van perifere lymfadenopathieÃ«n in lage-inkomenslanden. In hoog-inkomenslanden: 10â€“15% met lymfadenitis. Bij HIV: hogere incidentie en meer extrapulmonaal.
          </p>
          
          <div className="p-5 bg-primary-50 rounded-xl border border-primary-200">
            <h4 className="font-bold text-primary-800 mb-2">Kliniek</h4>
            <p className="text-primary-700 text-sm mb-2">
              Vaste, geÃ¯soleerde, chronische, niet-pijnlijke lymfadenopathie; meestal Ã©Ã©n locatie, soms meerdere. Predominantly cervical (60â€“80%, 'scrofula'). Koorts 20â€“50%. Vaste adhesie aan omgeving, soms fluctuatie/drainage, erythema nodosum.
            </p>
            <p className="text-primary-700 text-sm m-0">
              <strong>Transmissie:</strong> aÃ«rogeen, daarna hematogene verspreiding.
            </p>
          </div>
          ...
          <div className="p-5 bg-rose-50 rounded-xl border-l-4 border-rose-400">
            ...
            <p className="text-rose-700 text-sm mb-2">
              X-thorax (exclusie/demonstratie pulmonale TB). Lymfeklierbiopt (preferentieel, 70â€“90% vs 60% punctie). <strong>LET OP: biopt naar Medische Microbiologie, niet naar Pathologie.</strong>
            </p>
            <p className="text-rose-700 text-sm mb-2">
              MycobacteriÃ«le kweek (gouden standaard); PCR (GeneXpert): sensitiviteit 83%, specificiteit 94%. IGRA en TST zijn onvoldoende voor actieve TB â€“ antistoftests zijn niet geschikt voor actieve tuberculose.
            </p>
            <p className="text-rose-700 text-sm m-0">
      ...
      <section id="samenvatting" className="scroll-mt-24 mb-12">
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          <ul className="list-disc pl-6 space-y-2">
            ...
            <li>Toxoplasmose: zoÃ¶nose; kattenbak, vlees, congenitaal; 80â€“90% asymptomatisch; serologie, PCR.</li>
            <li>Kattenkrabziekte: krab/beet kat; regionale lymfadenitis (hals, oksel, lies); PCR op pus; spontane genezing.</li>
            <li>Tuberculeuze lymfadenitis: aÃ«rogeen; vaste cervicale klieren; biopt naar microbiologie; kweek, PCR.</li>
          </ul>
        </div>
      </section>
    </SummaryLayout>
  ...
  return (
    ...
    >
      ...
      <section id="intro" className="scroll-mt-24 mb-12">
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          <p>
            De verworven (adaptieve) immuniteit is de tweede verdedigingslinie. Initiatie vindt plaats in <strong>perifere lymfoÃ¯de organen</strong>. Deze module behandelt de basisprincipes; cellulaire verworven immuniteit komt in de casus uitgebreider aan bod; humorale immuniteit wordt in week 5 verder besproken.
          </p>
          ...
          <div className="p-5 bg-primary-50 rounded-xl border border-primary-200">
            ...
            <ul className="list-disc pl-6 space-y-1 text-primary-700 text-sm">
              ...
              <li>Benoemen welke lymfocyten belangrijk zijn voor afweer tegen bacteriÃ«n (B-lymfocyten) vs virussen (cytotoxische T-lymfocyten)</li>
            </ul>
          </div>
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm border-collapse">
              ...
              <tbody>
                <tr><td className="border border-slate-200 pl-3 py-2">B-lymfocyten</td><td className="border border-slate-200 pl-3 py-2">Antilichamen</td><td className="border border-slate-200 pl-3 py-2">â€”</td><td className="border border-slate-200 pl-3 py-2">â€”</td><td className="border border-slate-200 pl-3 py-2">â€”</td></tr>
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div className="p-5 bg-indigo-50 rounded-xl border border-indigo-200">
              ...
              <p className="text-indigo-700 text-sm m-0">
                T-helpercel â†’ B-cel â†’ <strong>antistoffen</strong>. B-cellen scheiden antilichamen uit. Richt zich tegen extracellulaire pathogenen.
              </p>
            </div>
            <div className="p-5 bg-rose-50 rounded-xl border border-rose-200">
              <h4 className="font-bold text-rose-800 mb-2">Cellulaire immuniteit</h4>
              <p className="text-rose-700 text-sm m-0">
                T-helpercel â†’ cytotoxische T-cellen. <strong>Cytotoxische T-cellen</strong> doden geÃ¯nfecteerde cellen (via perforine, granzyme). Cellulaire immuniteit omvat meer dan alleen cytotoxische T-cellen; ook andere T-cel subsets zijn betrokken.
              </p>
            </div>
          </div>
      ...
      <section id="effectorfase" className="scroll-mt-24 mb-12">
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          <p>
            <strong>B-lymfocyten</strong> zijn vooral betrokken bij het verwijderen van bacteriÃ«n (extracellulair; bacteriÃ«n zijn vooral aanwezig buiten cellen). <strong>Cytotoxische T-lymfocyten</strong> zijn vooral betrokken bij het verwijderen van virussen (intracellulair; virussen vermenigvuldigen zich in cellen).
          </p>
          
          <div className="p-5 bg-amber-50 rounded-xl border border-amber-200">
            <h4 className="font-bold text-amber-800 mb-2">T-helper subsets en cytokinen</h4>
            <ul className="list-disc pl-6 space-y-1 text-amber-700 text-sm">
              <li><strong>Th1</strong> (IFN-Î³, TNF-Î±, IL-2): intracellulaire pathogenen; activeert macrofagen; stimuleert proliferatie cytotoxische T-cellen</li>
          ...
          <div className="p-5 bg-slate-50 rounded-xl border-l-4 border-primary-400">
            ...
            <p className="text-slate-600 text-sm m-0">
              Bij afwezigheid van Treg: meer <strong>auto-immuunziekten</strong> en <strong>allergieÃ«n</strong>.
            </p>
          </div>
        </div>
      </section>
      ...
      <section id="samenvatting" className="scroll-mt-24 mb-12">
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          <ul className="list-disc pl-6 space-y-2">
            ...
            <li>Humorale immuniteit: B-cellen â†’ antistoffen. Cellulaire: cytotoxische T-cellen.</li>
            <li>T-helper activeert macrofagen, cytotoxische T-cellen, B-cellen.</li>
            <li>BacteriÃ«n: vooral B-lymfocyten. Virussen: vooral cytotoxische T-lymfocyten.</li>
            <li>Treg: regulatie; bij afwezigheid meer auto-immuunziekten en allergieÃ«n.</li>
          </ul>
        </div>
      </section>
    </SummaryLayout>
...
// Blok 4 - Week 3 Casus 6 LME 4: Secundaire lymfoÃ¯de organen Content
const SecundaireLymfoideOrganenSummary = () => {
  const tableOfContents = [
    { id: 'intro', title: 'Introductie', icon: BookOpen },
    { id: 'primaire-secundaire', title: 'Primaire vs secundaire lymfoÃ¯de organen', icon: Layers },
  ...
  return (
    <SummaryLayout
      title="Secundaire lymfoÃ¯de organen"
    ...
    >
      ...
      <section id="intro" className="scroll-mt-24 mb-12">
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          <p>
            Secundaire lymfoÃ¯de organen zijn de organen waar alles wat nodig is voor de totstandkoming van een immuunrespons op een efficiÃ«nte manier wordt samengebracht. De module behandelt de opbouw van de <strong>lymfeklier</strong> en de <strong>milt</strong>, het begrip <strong>MALT</strong> (mucosa-associated lymphoid tissue) en <strong>tertiaire lymfoÃ¯de structuren</strong>.
          </p>
          ...
          <div className="p-5 bg-primary-50 rounded-xl border border-primary-200">
            ...
            <ul className="list-disc pl-6 space-y-1 text-primary-700 text-sm">
              ...
              <li>Uitleggen wat bedoeld wordt met de term tertiaire lymfoÃ¯de structuren</li>
          ...
          <p className="text-slate-600 text-sm">
            Doelgroep: bachelor Geneeskunde, blok 4 â€“ Afweer en aanpak van infecties. Geschatte tijd: ~2 uur.
          </p>
        </div>
      </section>
      ...
      {/* Section 2: Primaire vs secundaire lymfoÃ¯de organen */}
      <section id="primaire-secundaire" className="scroll-mt-24 mb-12">
        <div className="flex items-center gap-3 mb-5">
          ...
          <h2 className="text-xl font-bold text-slate-900">
            Primaire vs secundaire lymfoÃ¯de organen
          </h2>
        </div>
        
        <div className="text-slate-700 space-y-4 leading-relaxed">
          <p>
            In <strong>primaire lymfoÃ¯de organen</strong> (thymus, beenmerg) worden lymfocyten gevormd vanuit voorlopercellen. In <strong>secundaire lymfoÃ¯de organen</strong> kunnen lymfocyten geactiveerd worden, leidend tot de totstandkoming van een immuunrespons.
          </p>
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          ...
          <div className="space-y-4">
            <div className="p-5 bg-teal-50 rounded-xl border border-teal-200">
              ...
              <p className="text-teal-700 text-sm mb-2">
                Meeste DC in <strong>paracortex</strong>; daar presenteren ze antigeen aan T-cellen. NaÃ¯eve T-cellen kunnen alleen door DC geactiveerd worden. DC in randsinus en trabekelsinussen zijn recent met de lymfe vanuit weefsels aangekomen.
              </p>
              <p className="text-teal-700 text-sm m-0">
            ...
            <div className="p-5 bg-emerald-50 rounded-xl border border-emerald-200">
              ...
              <p className="text-emerald-700 text-sm m-0">
                Als de B-celreceptor niet met hogere affiniteit bindt â†’ B-cel gaat in apoptose.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          ...
          <div className="p-5 bg-primary-50 rounded-xl border border-primary-200">
            ...
            <ul className="list-disc pl-6 space-y-1 text-primary-700 text-sm">
              ...
              <li>Reticulaire fibroblasten in verschillende compartimenten produceren verschillende chemokinen â†’ verdeling van T-cellen (paracortex) en B-cellen (outer cortex)</li>
            </ul>
          </div>
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm border-collapse">
              ...
              <tbody>
                ...
                <tr><td className="border border-slate-200 pl-3 py-2">Dendritische cellen</td><td className="border border-slate-200 pl-3 py-2">Afferente lymfe</td><td className="border border-slate-200 pl-3 py-2">â€”</td></tr>
                <tr><td className="border border-slate-200 pl-3 py-2">Macrofagen</td><td className="border border-slate-200 pl-3 py-2">Afferente lymfe</td><td className="border border-slate-200 pl-3 py-2">â€”</td></tr>
              </tbody>
            </table>
          </div>
      ...
      <section id="samenvatting" className="scroll-mt-24 mb-12">
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          <ul className="list-disc pl-6 space-y-2">
            ...
            <li>Lymfeklier: outer cortex (follikels) â†’ paracortex (HEV, T-cellen) â†’ medulla (mergstrengen, mergsinussen).</li>
