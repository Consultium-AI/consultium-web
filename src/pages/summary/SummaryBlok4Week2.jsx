...
// Blok 4 - Week 1 Casus 2 LME 1: Aangeboren immuniteit – respons Content
const AangeborenImmuniteitResponsSummary = () => {
  const tableOfContents = [
    { id: 'fagocytose', title: 'Fagocytose en antimicrobiële mechanismen', icon: Shield },
  ...
  return (
    <SummaryLayout
      title="Aangeboren immuniteit – respons"
    ...
    >
      {/* Section 1: Fagocytose en antimicrobiële mechanismen */}
      <section id="fagocytose" className="scroll-mt-24 mb-12">
        <div className="flex items-center gap-3 mb-5">
          ...
          <h2 className="text-xl font-bold text-slate-900">
            Fagocytose en antimicrobiële mechanismen
          </h2>
        </div>
        
        <div className="text-slate-700 space-y-4 leading-relaxed">
          <p>
            Myeloïde cellen zoals <strong>macrofagen</strong> en <strong>neutrofiele granulocyten</strong> ruimen extracellulaire micro-organismen op. Herkenning via receptoren leidt tot activatie van effectormechanismen.
          </p>
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm border-collapse">
              ...
              <tbody>
                ...
                <tr><td className="border border-slate-200 pl-3 py-2">2. Opslokking</td><td className="border border-slate-200 pl-3 py-2">Membraan sluit om microbe → fagosoom</td></tr>
                <tr><td className="border border-slate-200 pl-3 py-2">3. Doding en afbraak</td><td className="border border-slate-200 pl-3 py-2">Lysosomen fuseren met fagosoom → fagolysosoom; enzymatische afbraak</td></tr>
              </tbody>
            </table>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-4">
            ...
            <div className="p-5 bg-rose-50 rounded-xl border border-rose-200">
              ...
              <p className="text-rose-700 text-sm mb-2">
                NADPH-oxidase: O<sub>2</sub> → O<sub>2</sub>•<sup>−</sup> → H<sub>2</sub>O<sub>2</sub>. Met MPO en Cl<sup>−</sup> → HOCl (hypochlorig zuur).
              </p>
            </div>
            <div className="p-5 bg-purple-50 rounded-xl border border-purple-200">
              <h4 className="font-bold text-purple-800 mb-2">Stikstofoxide (NO)</h4>
              <p className="text-purple-700 text-sm m-0">
                iNOS zet arginine om in NO; samen met O<sub>2</sub>•<sup>−</sup> → reactieve stikstofspecies (RNS) voor microbiële doding.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div className="p-5 bg-blue-50 rounded-xl border border-blue-200">
              ...
              <ul className="space-y-1 text-blue-700 text-sm">
                <li>• Kan restanten van afgebroken micro-organismen uitscheiden</li>
                <li>• Scheidt na activatie mediatoren uit die NK-cellen en Th1-cellen activeren</li>
              </ul>
            </div>
            <div className="p-5 bg-teal-50 rounded-xl border border-teal-200">
              ...
              <ul className="space-y-1 text-teal-700 text-sm">
                <li>• Specifieke granula met collagenase en gelatinase → afbraak extracellulaire matrix voor migratie</li>
                <li>• Worden pas gerekruteerd als nodig; korte levensduur na activatie (enzymen schadelijk voor eigen weefsel)</li>
                <li>• <strong>NETose:</strong> DNA wordt uitgescheiden; micro-organismen plakken eraan en worden gedood</li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          ...
          <div className="p-5 bg-amber-50 rounded-xl border border-amber-200">
            ...
            <ul className="space-y-1 text-amber-700 text-sm">
              <li>• <strong>Klassieke route:</strong> antigeen-antilichaamcomplexen</li>
              <li>• <strong>Lectine route:</strong> lectine bindt aan pathogeenoppervlak (MB-lectine)</li>
              <li>• <strong>Alternatieve route:</strong> pathogeenoppervlakken direct</li>
            </ul>
          </div>
          ...
          <div className="p-5 bg-blue-50 rounded-xl border border-blue-200">
            ...
            <ul className="space-y-1 text-blue-700 text-sm">
              <li>• <strong>Recrutering inflammatoire cellen</strong></li>
              <li>• <strong>Opsonisatie</strong> van pathogenen</li>
              <li>• <strong>Doding</strong> van pathogenen</li>
            </ul>
          </div>
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm border-collapse">
              ...
              <tbody>
                ...
                <tr><td className="border border-slate-200 pl-3 py-2">C5–C9</td><td className="border border-slate-200 pl-3 py-2">Membraanaanvalscomplex (MAC); pore in membraan → lysis</td></tr>
              </tbody>
            </table>
          </div>
        </div>
      ...
      <section id="nk-cellen" className="scroll-mt-24 mb-12">
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          <p>
            <strong>Aangeboren lymfoïde cellen (ILCs)</strong> spelen een belangrijke rol in de aangeboren afweer. De bekendste zijn de <strong>NK-cellen</strong> (natural killer cells).
          </p>
          ...
          <div className="p-5 bg-indigo-50 rounded-xl border border-indigo-200">
            ...
            <p className="text-indigo-700 text-sm m-0">
              <strong>ADCC</strong> (antibody-dependent cellular cytotoxicity): Fcγ-receptoren (CD16) herkennen Fc-deel van IgG gebonden aan antigenen op doelwitcellen.
            </p>
          </div>
          ...
          <div className="p-5 bg-rose-50 rounded-xl border border-rose-200">
            ...
            <ul className="space-y-1 text-rose-700 text-sm">
              <li>• <strong>FasL–Fas interactie:</strong> inductie van apoptose</li>
              <li>• <strong>Perforine en granzymen:</strong> perforine maakt pore; granzymen induceren apoptose</li>
            </ul>
            <p className="text-rose-700 text-sm mt-2 m-0">
              NK-cellen scheiden ook IFNγ en TNFα uit voor immunomodulatie.
            </p>
          </div>
        </div>
      </section>
...
const AntibioticaLeerlijnSummary = () => {
  const tableOfContents = [
    ...
    { id: 'betalactam', title: 'Bètalactamantibiotica', icon: Shield },
  ...
  return (
    ...
    >
      ...
      <section id="introductie" className="scroll-mt-24 mb-12">
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          <p>
            <strong>Antibioticaresistentie</strong> vormt één van de grootste bedreigingen voor de gezondheidszorg. Door onnodig of onjuist gebruik verliezen steeds meer bacteriën hun gevoeligheid. Nieuwe klassen worden nauwelijks ontwikkeld; geschat wordt dat in 2050 jaarlijks ~10 miljoen mensen sterven aan de gevolgen van resistentie.
          </p>
          ...
          <div className="p-5 bg-amber-50 rounded-xl border border-amber-200">
            ...
            <p className="text-amber-700 text-sm m-0">
              Na 1987 zijn geen nieuwe klassen meer op de markt gekomen – alleen modificaties. Dit heet de <strong>discovery void</strong>.
            </p>
          </div>
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div className="p-5 bg-teal-50 rounded-xl border border-teal-200">
              ...
              <ul className="space-y-1 text-teal-700 text-sm">
                <li>• <strong>Smalspectrum:</strong> beperkte groep bacteriën</li>
                <li>• <strong>Breedspectrum:</strong> breed werkingsgebied</li>
              </ul>
            </div>
            <div className="p-5 bg-indigo-50 rounded-xl border border-indigo-200">
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm border-collapse">
              ...
              <tbody>
                <tr><td className="border border-slate-200 pl-3 py-2">Celwandsyntheseremmers</td><td className="border border-slate-200 pl-3 py-2">Bètalactamantibiotica (penicillinen, cefalosporinen, carbapenems)</td></tr>
                <tr><td className="border border-slate-200 pl-3 py-2">Nucleïnezuursyntheseremmers</td><td className="border border-slate-200 pl-3 py-2">Chinolonen (ciprofloxacine), metronidazol, nitrofurantoine</td></tr>
      ...
      {/* Section 3: Bètalactamantibiotica */}
      <section id="betalactam" className="scroll-mt-24 mb-12">
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          <p>
            Bètalactamantibiotica zijn <strong>celwandsyntheseremmers</strong>. Ze binden aan de bacteriële celwand en verstoren de vorming van de peptidoglycaanlaag. Ze bevatten allemaal een <strong>bètalactamring</strong>. Bacteriën kunnen <strong>bètalactamases</strong> produceren die deze antibiotica inactiveren.
          </p>
          
          <div className="p-5 bg-rose-50 rounded-xl border border-rose-200">
            <h4 className="font-bold text-rose-800 mb-2">Allergie</h4>
            <p className="text-rose-700 text-sm m-0">
              Een allergie voor de bètalactamring betekent allergie voor de hele groep. Een allergie kan ook specifiek zijn voor een zijketen (bijv. amoxicilline wel, penicilline niet).
            </p>
          </div>
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm border-collapse">
              ...
              <tbody>
                ...
                <tr><td className="border border-slate-200 pl-3 py-2">Penicilline + bètalactamaseremmer</td><td className="border border-slate-200 pl-3 py-2">Amoxicilline-clavulaanzuur (Augmentin®)</td></tr>
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          <div className="overflow-x-auto">
            <table className="w-full text-sm border-collapse">
              ...
              <tbody>
                <tr><td className="border border-slate-200 pl-3 py-2">Chinolonen</td><td className="border border-slate-200 pl-3 py-2">Nucleïnezuursynthese</td><td className="border border-slate-200 pl-3 py-2">Ciprofloxacine</td></tr>
                ...
                <tr><td className="border border-slate-200 pl-3 py-2">Overig</td><td className="border border-slate-200 pl-3 py-2">Nucleïnezuur / anaeroben</td><td className="border border-slate-200 pl-3 py-2">Nitrofurantoine, metronidazol</td></tr>
              </tbody>
            </table>
          </div>
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          ...
          <div className="p-5 bg-primary-50 rounded-xl border-l-4 border-primary-400">
            ...
            <ul className="space-y-1 text-primary-700 text-sm">
              <li>• Lokale resistentiepatronen</li>
              <li>• Toedieningsvorm</li>
              <li>• Allergieën</li>
              <li>• Bijwerkingen</li>
              <li>• Locatie van de infectie</li>
              <li>• Kosten</li>
            </ul>
          </div>
          ...
          <div className="p-5 bg-blue-50 rounded-xl border border-blue-200">
            ...
            <p className="text-blue-700 text-sm mb-2">
              <em>Neisseria meningitidis</em> is doorgaans gevoelig voor penicilline. Intracellulaire bacteriën (Legionella, Mycoplasma) zijn gevoelig voor macroliden zoals azitromycine, niet voor amoxicilline. Amoxicilline-clavulaanzuur dekt gram-positieven én gram-negatieve anaeroben (bijv. geïnfecteerde diabetische voet). Metronidazol voor anaerobendekking (bijv. geperforeerde appendicitis).
            </p>
          </div>
        </div>
      </section>
...
// Blok 4 - Week 1 Casus 2 LME 3: Introductie antimicrobiële therapie Content
const IntroductieAntimicrobieleTherapieSummary = () => {
  const tableOfContents = [
    ...
    { id: 'replicatie', title: 'Bacteriële replicatie verstoren', icon: Layers },
    { id: 'middelen', title: 'Antimicrobiële middelen en resistentie', icon: ClipboardCheck },
  ]

  return (
    <SummaryLayout
      title="Introductie antimicrobiële therapie"
      description="Principes voor de behandeling van infectieziekten: self-limiting infecties, focusverwijdering en verstoring van bacteriële replicatie."
      caseLabel="Casus 2: Vrouw met Urineweginfectie"
      tableOfContents={tableOfContents}
    ...
    >
      ...
      <section id="principes" className="scroll-mt-24 mb-12">
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          ...
          <div className="grid md:grid-cols-3 gap-4">
            ...
            <div className="p-5 bg-indigo-50 rounded-xl border border-indigo-200">
              <h4 className="font-bold text-indigo-800 mb-2">Replicatie beïnvloeden</h4>
              <p className="text-indigo-700 text-sm m-0">
                De replicatie van de verwekker verstoren met antimicrobiële middelen.
              </p>
            </div>
          </div>
      ...
      <section id="self-limiting" className="scroll-mt-24 mb-12">
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          ...
          <div className="p-5 bg-blue-50 rounded-xl border border-blue-200">
            ...
            <ul className="space-y-1 text-blue-700 text-sm">
              <li>• <strong>Influenza (griep)</strong> – vaak self-limiting bij gezonde personen</li>
              <li>• <strong>Waterpokken (varicella)</strong> – meestal geen behandeling nodig</li>
            </ul>
          </div>
          
          <p>
            Ook veel <strong>bacteriële infecties</strong> gaan vanzelf over, bijvoorbeeld diarree veroorzaakt door <em>E. coli</em>.
          </p>
          
          <div className="p-5 bg-rose-50 rounded-xl border border-rose-200">
            <h4 className="font-bold text-rose-800 mb-2">Immunogecompromitteerde patiënten</h4>
            <p className="text-rose-700 text-sm mb-2">
              Patiënten die een stamceltransplantatie hebben ondergaan gebruiken veel <strong>immuunsuppressiva</strong>. De eigen afweer is vaak niet in staat infecties te bestrijden; de kans op infecties met <strong>opportunistische micro-organismen</strong> is groter.
            </p>
            <p className="text-rose-700 text-sm m-0">
      ...
      <section id="focus" className="scroll-mt-24 mb-12">
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          ...
          <div className="p-5 bg-primary-50 rounded-xl border-l-4 border-primary-400">
            ...
            <ul className="space-y-1 text-primary-700 text-sm">
              <li>• <strong>Drainage</strong> van een abces</li>
              <li>• Verwijderen van een geïnfecteerd implantaat of katheter</li>
              <li>• Chirurgische sanering van geïnfecteerd weefsel</li>
            </ul>
          </div>
        </div>
      </section>
      ...
      {/* Section 4: Bacteriële replicatie verstoren */}
      <section id="replicatie" className="scroll-mt-24 mb-12">
        <div className="flex items-center gap-3 mb-5">
          ...
          <h2 className="text-xl font-bold text-slate-900">
            Bacteriële replicatie verstoren
          </h2>
        </div>
        
        <div className="text-slate-700 space-y-4 leading-relaxed">
          <p>
            Het stoppen van het metabolisme van een cel of organisme, waardoor deze niet meer kan functioneren en/of zich kan repliceren en tenslotte te gronde gaat, is een effectieve manier van antimicrobiële therapie.
          </p>
          
          <div className="grid md:grid-cols-2 gap-4">
            <div className="p-5 bg-indigo-50 rounded-xl border border-indigo-200">
              <h4 className="font-bold text-indigo-800 mb-2">Antimicrobiële geneesmiddelen</h4>
              <p className="text-indigo-700 text-sm m-0">
                Meestal wordt gebruik gemaakt van antimicrobiële geneesmiddelen, zoals <strong>antibiotica</strong>.
              </p>
            </div>
            <div className="p-5 bg-violet-50 rounded-xl border border-violet-200">
              ...
              <p className="text-violet-700 text-sm m-0">
                Ook met <strong>bacteriofagen</strong> kunnen bacteriën te gronde gericht worden. Aan faagtherapie zitten veel haken en ogen; in de westerse geneeskunde is dit (nog) geen gangbare therapie.
              </p>
            </div>
          </div>
        </div>
      ...
      {/* Section 5: Antimicrobiële middelen en resistentie */}
      <section id="middelen" className="scroll-mt-24 mb-12">
        <div className="flex items-center gap-3 mb-5">
          ...
          <h2 className="text-xl font-bold text-slate-900">
            Antimicrobiële middelen en resistentie
          </h2>
        </div>
        
        <div className="text-slate-700 space-y-4 leading-relaxed">
          <p>
            Antimicrobiële middelen kunnen worden onderverdeeld in:
          </p>
  ...
  return (
    ...
    >
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm border-collapse">
              ...
              <tbody>
                <tr><td className="border border-slate-200 pl-3 py-2"><strong>Bacteriurie</strong></td><td className="border border-slate-200 pl-3 py-2">Aanwezigheid van bacteriën in de urine</td></tr>
                <tr><td className="border border-slate-200 pl-3 py-2"><strong>Significante bacteriurie</strong></td><td className="border border-slate-200 pl-3 py-2">≥10⁵ kve/ml urine</td></tr>
      ...
      <section id="pathogenese" className="scroll-mt-24 mb-12">
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          <p>
            De meeste urineweginfecties ontstaan door <strong>darmbacteriën</strong>. Bij vrouwen is de endeldarm dicht bij de urethra; bacteriën kunnen gemakkelijk koloniseren. Vrouwen hebben vaker urineweginfecties dan mannen door de <strong>kortere urethra</strong>.
          </p>
          ...
          <div className="p-5 bg-emerald-50 rounded-xl border border-emerald-200">
            ...
            <ul className="space-y-1 text-emerald-700 text-sm">
              <li>• <strong>Neutrofielen:</strong> adhesinen (fimbriae E. coli) activeren receptoren → IL-8, CXCR1 → neutrofielen</li>
              <li>• <strong>pH en osmolaliteit:</strong> hoge osmolaliteit, lage pH (~6) maken overleving moeilijk</li>
              <li>• <strong>Antibacteriële factoren:</strong> complement, mucosaal IgA, Tamm-Horsfall-eiwitten</li>
              <li>• <strong>Normale flora:</strong> grampositieve staven, streptokokken, anaeroben houden pathogene bacteriën buiten</li>
              <li>• <strong>Urineflow:</strong> goede doorloop en volledige blaaslediging essentieel; <strong>residu</strong> = urine die achterblijft; <strong>retentieblaas</strong> = blaas met residu</li>
            </ul>
          </div>
      ...
      <section id="klachten" className="scroll-mt-24 mb-12">
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          <div className="p-5 bg-primary-50 rounded-xl border border-primary-200">
            ...
            <ul className="space-y-1 text-primary-700 text-sm">
              <li>• Dysurie (pijnlijke/branderige mictie), pollakisurie, toegenomen mictiefrequentie</li>
              <li>• Loze aandrang, hematurie, troebele/stinkende urine, pijn onderbuik/rug</li>
            </ul>
          </div>
          ...
          <div className="p-5 bg-amber-50 rounded-xl border border-amber-200">
            ...
            <p className="text-amber-700 text-sm m-0">
              <strong>Urosepsis:</strong> bacteriën in de bloedbaan → septische shock (daling bloeddruk, onvoldoende orgaanperfusie). Levensbedreigend.
            </p>
          </div>
        </div>
      </section>
      ...
      <section id="diagnostiek" className="scroll-mt-24 mb-12">
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          <p>
            Een goede <strong>anamnese</strong> is essentieel. Vraag naar klachten passend bij cystitis én tekenen van weefselinvasie. Differentiaal: vaginale afscheiding, urethra-uitvloed, klachten &gt;1 week, SOA-risico.
          </p>
          
          <div className="p-5 bg-teal-50 rounded-xl border border-teal-200">
            <h4 className="font-bold text-teal-800 mb-2">Risicogroepen (gecompliceerd beloop)</h4>
            <ul className="space-y-1 text-teal-700 text-sm">
              <li>• Verminderde weerstand, diabetes mellitus</li>
              <li>• Afwijkingen nieren/urinewegen (nierfunctiestoornissen, cystenieren, nierstenen, neurogene blaas)</li>
              <li>• Zwangeren, mannen, kinderen &lt;12 jaar</li>
            </ul>
          </div>
          
          <div className="p-5 bg-blue-50 rounded-xl border border-blue-200">
            <h4 className="font-bold text-blue-800 mb-2">Lichamelijk onderzoek geïndiceerd bij</h4>
            <ul className="space-y-1 text-blue-700 text-sm">
              <li>• Vrouwen met recidiverende UWI (≥3/jaar), mannen, kinderen</li>
              <li>• Koorts of tekenen van weefselinvasie</li>
              <li>• Patiënten bij wie anamnese niet mogelijk is</li>
            </ul>
            <p className="text-blue-700 text-sm mt-2 m-0">
              Onderdelen: buikonderzoek (urineretentie, flankpijn, peritoneale prikkeling), inspectie genitale regio, rectaal toucher (niet bij prostatitis; wel bij vermoeden prostaatvergroting). Bij weefselinvasie: beoordelen mate van ziek-zijn (bloeddruk, saturatie, hartfrequentie, sufheid); instabiele patiënt → ziekenhuis.
            </p>
          </div>
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm border-collapse">
              ...
              <tbody>
                ...
                <tr><td className="border border-slate-200 pl-3 py-2"><strong>Urinesediment</strong></td><td className="border border-slate-200 pl-3 py-2">Microscopisch: leukocyten en bacteriën</td></tr>
                ...
                <tr><td className="border border-slate-200 pl-3 py-2"><strong>Kweek</strong></td><td className="border border-slate-200 pl-3 py-2">Identificatie verwekker; gevoeligheidsbepaling; geen groei na 24–48 uur = &lt;100 kve/ml</td></tr>
              </tbody>
            </table>
          </div>
      ...
      <section id="behandeling" className="scroll-mt-24 mb-12">
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          ...
          <div className="p-5 bg-teal-50 rounded-xl border border-teal-200">
            ...
            <p className="text-teal-700 text-sm m-0">
              Antibiotica met weefselpenetratie en breder spectrum: <strong>ciprofloxacine</strong>, <strong>amoxicilline-clavulaanzuur</strong>, <strong>co-trimoxazol</strong>. Gevoeligheidsbepaling belangrijk. Bij urosepsis: orale behandeling te risicovol → ziekenhuis.
            </p>
          </div>
          ...
          <div className="p-5 bg-amber-50 rounded-xl border border-amber-200">
            ...
            <p className="text-amber-700 text-sm m-0">
              <strong>Zwangerschap en lactatie:</strong> medicatie kan ontwikkeling ongeboren kind beïnvloeden; sommige antibiotica gaan over in borstvoeding.
            </p>
          </div>
        </div>
      </section>
    ...
    >
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm border-collapse">
              ...
              <tbody>
                ...
                <tr><td className="border border-slate-200 pl-3 py-2"><strong>RIVM</strong></td><td className="border border-slate-200 pl-3 py-2">Nationale richtlijnen; coördinatie infectieziektenbestrijding; monitoring landelijke trends</td></tr>
                ...
                <tr><td className="border border-slate-200 pl-3 py-2"><strong>Zorgmedewerkers</strong></td><td className="border border-slate-200 pl-3 py-2">Naleven protocollen; melden afwijkingen; handhygiëne; correcte katheterzorg</td></tr>
              </tbody>
            </table>
          </div>
        </div>
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm border-collapse">
              ...
              <tbody>
                ...
                <tr><td className="border border-slate-200 pl-3 py-2"><strong>Endogene bron</strong></td><td className="border border-slate-200 pl-3 py-2">Micro-organismen al aanwezig in/op het lichaam (huidflora, darmbacteriën); kunnen onder bepaalde omstandigheden infectie veroorzaken</td></tr>
      ...
      <section id="transmissie" className="scroll-mt-24 mb-12">
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          ...
          <div className="p-5 bg-primary-50 rounded-xl border border-primary-200">
            <h4 className="font-bold text-primary-800 mb-2">Vijf momenten van handhygiëne</h4>
            <ul className="space-y-1 text-primary-700 text-sm">
              <li>• Voor contact met een patiënt</li>
              <li>• Voor een aseptische handeling</li>
              <li>• Na blootstelling aan lichaamsvloeistoffen</li>
              <li>• Na contact met een patiënt</li>
              <li>• Na contact met de directe omgeving van een patiënt</li>
            </ul>
          </div>
          ...
          <div className="p-5 bg-teal-50 rounded-xl border border-teal-200">
            ...
            <p className="text-teal-700 text-sm m-0">
              Voorkomen van besmetting van steriele lichaamsgebieden, wonden en medische hulpmiddelen: steriele handschoenen en materialen, desinfectie huid vóór invasieve procedures, handhygiëne vóór aseptische handelingen.
            </p>
          </div>
  ...
  return (
    ...
    >
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            ...
            <div className="p-5 bg-teal-50 rounded-xl border border-teal-200">
              ...
              <p className="text-teal-700 text-sm m-0">
                Luchtpijp, bronchiën en longweefsel (longblaasjes). Belangrijkste syndromen: bronchiolitis en pneumonie.
              </p>
            </div>
          </div>
      ...
      <section id="verwekkers" className="scroll-mt-24 mb-12">
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          <p>
            Er is overlap in verwekkers tussen bronchiolitis en pneumonie. In een individuele patiënt kunnen de verschijnselen vaak niet aan een specifieke verwekker gekoppeld worden.
          </p>
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm border-collapse">
              ...
              <tbody>
                ...
                <tr><td className="border border-slate-200 pl-3 py-2"><strong>Typische pneumonie</strong></td><td className="border border-slate-200 pl-3 py-2">Streptococcus pneumoniae, Haemophilus influenzae, Moraxella catarrhalis; bij Influenza: bacteriële superinfectie met Staphylococcus aureus</td></tr>
      ...
      <section id="kliniek" className="scroll-mt-24 mb-12">
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          <div className="p-5 bg-primary-50 rounded-xl border border-primary-200">
            ...
            <p className="text-primary-700 text-sm m-0">
              <strong>Kliniek:</strong> forse rhinorroe → tachy-dyspnoe en hoesten; hoge koorts ongebruikelijk. Auscultatoir: piepende en ratelende bijgeluiden.
            </p>
          </div>
          ...
          <div className="p-5 bg-teal-50 rounded-xl border border-teal-200">
            ...
            <p className="text-teal-700 text-sm m-0">
              Plotselinge hoge koorts, hoesten, tachy-dyspnoe. Kinderen maken een zieke indruk; thoracale pijn → oppervlakkige ademhaling. Auscultatoir: gedempte percussie, verminderd ademgeruis, crepitaties. Bacteriële superinfectie na virale infectie: (opnieuw) stijgende temperatuur en toename ziek-zijn.
            </p>
          </div>
          ...
          <div className="p-5 bg-indigo-50 rounded-xl border border-indigo-200">
            ...
            <p className="text-indigo-700 text-sm m-0">
              Diffuus beeld; minder acuut; myalgie, artralgie, hoofdpijn. Extra-pulmonale verschijnselen (exantheem, mucositis, Stevens-Johnson) kunnen wijzen op Mycoplasma. Zuigeling 5–14 dagen met pussende conjunctivitis → Chlamydophila trachomatis. Vogelcontact → Chlamydophila psittaci. Veecontact → Q-koorts. Legionella: aerosolen van vervuild water.
            </p>
          </div>
          ...
          <div className="p-5 bg-amber-50 rounded-xl border border-amber-200">
            ...
            <p className="text-amber-700 text-sm m-0">
              <strong>Ernstig:</strong> ademhaling &gt;70/min (&lt;2 jaar) of &gt;50/min (≥2 jaar), matige–ernstige intrekkingen, neusvleugelen, apneus, saturatie &lt;92%, tachycardie, capillary refill ≥2 sec, niet meer zelf drinken, temperatuur ≥38,5 °C.
            </p>
          </div>
        </div>
      </section>
      ...
      <section id="diagnostiek" className="scroll-mt-24 mb-12">
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          <p>
            Bij een ongecompliceerde onderste luchtweginfectie is <strong>niet standaard</strong> aanvullend onderzoek geïndiceerd; de diagnose wordt vooral klinisch gesteld.
          </p>
          
          <div className="p-5 bg-rose-50 rounded-xl border border-rose-200">
            <h4 className="font-bold text-rose-800 mb-2">Niet aanbevolen</h4>
            <ul className="space-y-1 text-rose-700 text-sm">
              <li>• Bloedonderzoek (CRP, leukocyten, BSE, PCT, IL-6) differentieert onvoldoende tussen viraal en bacterieel</li>
              <li>• Serologie Mycoplasma/Chlamydophila in acute fase</li>
              <li>• X-thorax draagt niet bij aan klinische diagnose; geen onderscheid bacterieel/viraal</li>
            </ul>
          </div>
      ...
      <section id="therapie" className="scroll-mt-24 mb-12">
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          <div className="p-5 bg-primary-50 rounded-xl border border-primary-200">
            ...
            <ul className="space-y-1 text-primary-700 text-sm">
              <li>• <strong>Bronchiolitis:</strong> alleen bij sterke verdenking bacteriële superinfectie</li>
              <li>• <strong>Kinderen &lt;2 jaar</strong> met milde symptomen: geen antibiotica (veelal geen bacteriële pneumonie)</li>
              <li>• <strong>Niet ziek-ogende kinderen ≥2 jaar</strong> met milde symptomen: expectatief beleid + follow-up</li>
              <li>• <strong>Ziek ogende kinderen</strong> met verdenking pneumonie: wel antibiotica (bacterieel en viraal niet betrouwbaar te onderscheiden)</li>
            </ul>
          </div>
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm border-collapse">
              ...
              <tbody>
                ...
                <tr><td className="border border-slate-200 pl-3 py-2">Secundaire bacteriële infectie bij Influenza</td><td className="border border-slate-200 pl-3 py-2">Amoxicilline-clavulaanzuur of cefuroxim</td></tr>
              </tbody>
            </table>
          </div>
          ...
          <div className="p-5 bg-teal-50 rounded-xl border border-teal-200">
            ...
            <ul className="space-y-1 text-teal-700 text-sm">
              <li>• <strong>Bronchiolitis:</strong> geen corticosteroïden; geen antivirale middelen tegen RSV; proef salbutamol/ipratropium (stoppen indien geen effect)</li>
              <li>• <strong>Influenza:</strong> oseltamivir binnen 48 uur bij dreigende respiratoire insufficiëntie</li>
              <li>• <strong>Zuurstof:</strong> bij saturatie ≤92% of verhoogde ademarbeid; HFNC indien neusbril onvoldoende</li>
              <li>• <strong>Vocht/voeding:</strong> sonde bij onvoldoende intake of dreigende dehydratie</li>
            </ul>
          </div>
        </div>
      </section>
      ...
      <section id="kinkhoest" className="scroll-mt-24 mb-12">
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          ...
          <div className="p-5 bg-primary-50 rounded-xl border border-primary-200">
            ...
            <ul className="space-y-1 text-primary-700 text-sm">
              <li>• <strong>Catarrale fase</strong> (1–2 weken): rhinorroe, milde hoest; hoge koorts ongebruikelijk</li>
              <li>• <strong>Paroxysmale fase:</strong> verstikkende hoestbuien, gierende inspiratie; bij zuigelingen &lt;3 maanden: apneus, plotse dood</li>
              <li>• <strong>Reconvalescentiefase:</strong> persisterend hoesten; samen ~100 dagen (&lsquo;100-dagen hoest&rsquo;)</li>
            </ul>
          </div>
      ...
      <section id="gecompliceerd" className="scroll-mt-24 mb-12">
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          <p>
            Gecompliceerd bij: <strong>longabces</strong>, <strong>pleura-empyeem</strong>, <strong>aspiratie</strong>, of <strong>HAP</strong> (begin ≥48 uur na opname).
          </p>
          ...
          <div className="p-5 bg-amber-50 rounded-xl border border-amber-200">
            ...
            <p className="text-amber-700 text-sm m-0">
              Eerste keus i.v.: HAP → cefuroxim + gentamicine; aspiratie (ziekenhuis) → amoxicilline-clavulaanzuur + gentamicine; aspiratie (thuis) → amoxicilline-clavulaanzuur; pleura-empyeem → cefuroxim + clindamycine. Empyeem: punctie bij vochtschil &gt;1 cm; drainage overwogen.
            </p>
          </div>
        </div>
      </section>
  ...
  return (
    ...
    >
      ...
      <section id="zones" className="scroll-mt-24 mb-12">
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          <p>
            De luchtwegen worden onderverdeeld in een <strong>geleidende zone</strong> (warmt en reinigt de lucht) en een <strong>respiratoire zone</strong> (gaswisseling O₂ en CO₂).
          </p>
          
          <div className="p-5 bg-primary-50 rounded-xl border border-primary-200">
            <h4 className="font-bold text-primary-800 mb-2">Verloop van de luchtwegen</h4>
            <p className="text-primary-700 text-sm m-0">
              Neus → farynx → larynx → trachea → bronchi → bronchioli → terminale bronchioli → <strong>respiratoire bronchioli</strong> → ductuli alveolares → sacculi alveolares (trosjes alveoli). De respiratoire zone begint bij de respiratoire bronchioli.
            </p>
          </div>
      ...
      <section id="epitheel" className="scroll-mt-24 mb-12">
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          <p>
            Van neus tot en met bronchiën: <strong>respiratoir epitheel</strong> (meerrijig cilindrisch epitheel). Alle vijf celtypen maken contact met het basaalmembraan:
          </p>
          ...
          <div className="p-5 bg-amber-50 rounded-xl border border-amber-200">
            ...
            <p className="text-amber-700 text-sm m-0">
              Respiratoir epitheel wordt af en toe onderbroken door plaveiselepitheel (stembanden, oropharynx). Vanaf bronchioli: eenlagig cilindrisch epitheel → kubisch → plat bij alveoli.
            </p>
          </div>
        </div>
      </section>
      ...
      <section id="trachea-bronchi" className="scroll-mt-24 mb-12">
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          <div className="p-5 bg-primary-50 rounded-xl border border-primary-200">
            ...
            <p className="text-primary-700 text-sm m-0">
              Ongeveer 10–12 cm lang. Bevat hoefijzervormige kraakbeenringen; aan dorsale zijde de <strong>musculus trachealis</strong>. Splitst in 2 primaire bronchi.
            </p>
          </div>
          ...
          <div className="p-5 bg-teal-50 rounded-xl border border-teal-200">
            ...
            <p className="text-teal-700 text-sm m-0">
              <strong>Club cellen</strong> (Clara cellen): kubische cellen zonder cilia; scheiden antimicrobiële producten en <strong>surfactant</strong> uit; kunnen als stamcellen dienen.
            </p>
          </div>
        </div>
      </section>
      ...
      <section id="alveoli" className="scroll-mt-24 mb-12">
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          <p>
            Alveoli zijn van elkaar gescheiden door <strong>interalveolaire septa</strong> (elastisch bindweefsel). Poriën verbinden alveoli; bij obstructie kan lucht via poriën omzeild worden. Capillairen in de septa voor efficiënte gaswisseling.
          </p>
          ...
          <div className="p-5 bg-teal-50 rounded-xl border border-teal-200">
            <h4 className="font-bold text-teal-800 mb-2">Bloed-luchtbarrière</h4>
            <p className="text-teal-700 text-sm m-0">
              Gaswisseling via Type I pneumocyt → basaalmembraan → endotheelcel. Surfactant voorkomt dat alveoli door oppervlaktespanning in elkaar klappen.
            </p>
          </div>
        </div>
      </section>
      ...
      <section id="afweer" className="scroll-mt-24 mb-12">
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          <ul className="space-y-2">
            <li>• <strong>Hoesten en niezen:</strong> mechanische verwijdering van irriterende stoffen</li>
            <li>• <strong>Fagocytose door macrofagen:</strong> opruimen van bacteriën en deeltjes</li>
            <li>• <strong>Trilhaardragend epitheel:</strong> muco-ciliary escalator</li>
          </ul>
          
          <div className="p-5 bg-teal-50 rounded-xl border border-teal-200">
            <h4 className="font-bold text-teal-800 mb-2">Muco-ciliary escalator</h4>
            <p className="text-teal-700 text-sm mb-2">
              Cilia bewegen gecoördineerd in golfbewegingen en transporteren slijm (met vuil en bacteriën) richting de mond. Normale cilia: <strong>9+2 microtubuli-structuur</strong> (9 perifere dubbele microtubuli, 2 centrale).
            </p>
            <p className="text-teal-700 text-sm m-0">
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            ...
            <div className="p-5 bg-rose-50 rounded-xl border border-rose-200">
              ...
              <p className="text-rose-700 text-sm m-0">
                Cilia zijn gedeformeerd en bewegen niet samen → <strong>ophoping van slijm</strong> met vuil en bacteriën → verhoogd risico op infecties.
              </p>
            </div>
          </div>
        </div>
...
const PathofysiologieViraleLuchtweginfectiesSummary = () => {
  ...
  return (
    <SummaryLayout
      ...
      description="Virale luchtweginfecties: SARS-CoV-2, influenzavirus en RSV – pathofysiologie, kliniek en behandeling."
      caseLabel="Casus 3: Kind met RS-virus"
      tableOfContents={tableOfContents}
    ...
    >
      ...
      <section id="intro" className="scroll-mt-24 mb-12">
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          <p>
            Bovenste luchtweginfecties (BLWI) worden meestal door <strong>virussen</strong> veroorzaakt. Virale infecties verhogen het risico op secundaire bacteriële infecties (otitis media, sinusitis, pneumonie).
          </p>
      ...
      <section id="diagnostiek" className="scroll-mt-24 mb-12">
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          ...
          <div className="p-5 bg-teal-50 rounded-xl border border-teal-200">
            ...
            <p className="text-teal-700 text-sm m-0">
              <strong>Virale genoomdetectie</strong> via moleculaire test (multiplex (RT-)PCR). Detecteert meerdere pathogenen tegelijk. Sneltesten beschikbaar (&lt;1 uur): SARS-CoV-2, RSV, influenza A en B. Uitgebreider panel: RSV, influenza A/B, hMPV, seizoenscoronavirussen, parainfluenza 1–4, adenovirus, bocavirus, enterovirus.
            </p>
          </div>
      ...
      <section id="sars-cov2" className="scroll-mt-24 mb-12">
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          ...
          <div className="p-5 bg-teal-50 rounded-xl border border-teal-200">
            ...
            <p className="text-teal-700 text-sm m-0">
              mRNA-vaccins: lipid nanoparticles met mRNA voor spike-eiwit. Humorale immuniteit: B-cellen produceren neutraliserende antistoffen. Cellulaire immuniteit: virus-specifieke B- en T-cellen voor immunologisch geheugen; CD8+ elimineren geïnfecteerde cellen; CD4+ ondersteunen immuunreacties.
            </p>
          </div>
          ...
          <div className="p-5 bg-amber-50 rounded-xl border border-amber-200">
            ...
            <p className="text-amber-700 text-sm m-0">
              CoV-229E, -NL63 (alfacoronavirussen), CoV-OC43, -HKU1 (bètacoronavirussen). Vooral bovenste luchtweginfecties (rhinitis); wereldwijd, piek winter. CoV-NL63: associatie met laryngotracheitis (kroep) bij kinderen. SARS en MERS: bètacoronavirussen; zoönotisch; hoge mortaliteit.
            </p>
          </div>
        </div>
      </section>
      ...
      <section id="influenza" className="scroll-mt-24 mb-12">
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          <p>
            Familie <strong>Orthomyxoviridae</strong>. Drie typen: A, B, C. Influenza A en B belangrijkst voor de mens. Envelop; gesegmenteerd negatief enkelstrengs RNA (8 segmenten A/B, 7 bij C); 9–11 eiwitten.
          </p>
          ...
          <div className="p-5 bg-teal-50 rounded-xl border border-teal-200">
            ...
            <p className="text-teal-700 text-sm mb-2">
              <strong>Influenza A:</strong> subtypering op HA en NA (18 HA, 11 NA); H1N1, H3N2; kan pandemieën veroorzaken; veel subtypes; verandert snel.
            </p>
            <p className="text-teal-700 text-sm m-0">
          ...
          <div className="p-5 bg-amber-50 rounded-xl border border-amber-200">
            ...
            <p className="text-amber-700 text-sm m-0">
              <strong>Shift:</strong> grote veranderingen door genetische reassortment (twee virussen infecterenzelfde cel); varkens als mengvat (humaan + aviair); nieuw subtype → pandemie. Voorbeeld: influenza A(H1N1)pdm09 (2009).
            </p>
          </div>
          ...
          <div className="p-5 bg-rose-50 rounded-xl border border-rose-200">
            ...
            <p className="text-rose-700 text-sm mb-2">
              Acuut begin; koorts, malaise, hoofdpijn, spierpijn, rhinitis, hoesten, keelpijn. Ongecompliceerd: ~3 dagen. Complicaties: primaire virale pneumonie, secundaire bacteriële infectie (S. pneumoniae, H. influenzae, S. aureus), ontregeling chronische ziekte.
            </p>
            <p className="text-rose-700 text-sm m-0">
              <strong>Diagnostiek:</strong> multiplex PCR. <strong>Behandeling:</strong> oseltamivir bij opgenomen patiënten met PCR-bewezen influenza; start binnen 48 uur symptomen; bij immuungecompromitteerden laagdrempelig. Vaccinatie: jaarlijks aangepast; risicogroepen (Gezondheidsraad); typisch H3N2, H1N1, B (Yamagata/Victoria).
            </p>
          </div>
        </div>
      </section>
      ...
      <section id="rsv" className="scroll-mt-24 mb-12">
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          <p>
            Naam door vermogen <strong>syncytia</strong> (grote meerkernige cellen) te vormen. Enkelstrengs RNA; 120–300 nm; lipide-envelop. Glycoproteïnen F (fusie) en G (hechting); F en G induceren neutraliserende antistoffen. Twee groepen: A en B.
          </p>
          
          <div className="p-5 bg-primary-50 rounded-xl border border-primary-200">
            <h4 className="font-bold text-primary-800 mb-2">Epidemiologie</h4>
            <p className="text-primary-700 text-sm m-0">
              Transmissie: aerosolen, hand–slijmvliescontact. Incubatie 2–8 dagen (meestal 5). Besmettelijk kort voor ziektebegin. Bijna alle kinderen &lt;3 jaar hebben RSV-IgG; herinfecties frequent; cellulaire en humorale immuniteit bieden onvoldoende bescherming; herinfecties milder dan primaire infectie.
            </p>
          </div>
          ...
          <div className="p-5 bg-teal-50 rounded-xl border border-teal-200">
            ...
            <p className="text-teal-700 text-sm mb-2">
              Ontsteking bronchioli; vooral kinderen &lt;2 jaar; incidentie hoogst in eerste levensjaar. Oorzaak winterepidemie: meestal RSV. 10–40% van jonge kinderen met RSV-infectie ontwikkelt bronchiolitis; 10% ziekenhuisopname (hypoxie, voedingsproblemen); 10% van opnames behoeft PICU.
            </p>
            <p className="text-teal-700 text-sm m-0">
              <strong>Pathofysiologie:</strong> virus via neus/keel/ogen → infecteert trilhaarepitheel → verspreiding naar bronchi, bronchioli, alveoli. Direct cytopathologisch effect + overmatige immuunrespons. Inflammatie, oedeem (sub)mucosa, necrose trilhaarcellen, mucusproductie → verminderde sputumklaring, airtrapping, atelectase, shunting. Kleine bronchioli bij zuigelingen → snelle obstructie.
            </p>
          </div>
          ...
          <div className="p-5 bg-amber-50 rounded-xl border border-amber-200">
            ...
            <p className="text-amber-700 text-sm mb-2">
              <strong>Complicaties:</strong> apneus, respiratoire ondersteuning, vochtoverbelasting (SIADH), secundaire bacteriële pneumonie, mogelijk latere astma.
            </p>
            <p className="text-amber-700 text-sm mb-2">
          ...
          <div className="p-5 bg-slate-50 rounded-xl border border-slate-200">
            ...
            <p className="text-slate-700 text-sm m-0">
              Voor COVID-19: vooral november–maart. Tijdens pandemie 2020/21: weinig RSV door maatregelen. Terugkeer zomer 2021: piek eind juli; verhoogde incidentie ~1 jaar. Vanaf 2022/23 weer herfst/winter-seizoenspatroon.
            </p>
          </div>
        </div>
      </section>
    ...
    >
      ...
      <section id="begrippen" className="scroll-mt-24 mb-12">
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          ...
          <div className="p-5 bg-primary-50 rounded-xl border border-primary-200">
            ...
            <p className="text-primary-700 text-sm mb-2">
              Het interval tussen besmetting en het begin van symptomen. Voorbeelden: influenza 1–3 dagen; hepatitis B 30–180 dagen; EBV 21–49 dagen; VZV 10–21 dagen; mazelen 7–18 dagen.
            </p>
            <p className="text-primary-700 text-sm m-0">
              <strong>Besmettelijke periode:</strong> influenza: dag vóór symptomen tot 5–7 dagen; hepatitis B: ca. 6 weken vóór klachten tot verdwijnen HBsAg; VZV: 2 dagen vóór huiduitslag tot indrogen blaasjes; mazelen: 4 dagen vóór tot 4 dagen na exantheem.
            </p>
          </div>
      ...
      <section id="transmissie" className="scroll-mt-24 mb-12">
        <div className="flex items-center gap-3 mb-5">
          ...
          <h2 className="text-xl font-bold text-slate-900">
            Transmissieroutes en porte d'entrée
          </h2>
        </div>
        
        <div className="text-slate-700 space-y-4 leading-relaxed">
          <p>
            Virussen bereiken de gastheer via verschillende <strong>besmettingsbronnen</strong> en <strong>transmissieroutes</strong>. Naast horizontale transmissie (mens-op-mens) bestaat verticale transmissie (moeder–kind: transplacentair of perinataal).
          </p>
          ...
          <div className="p-5 bg-amber-50 rounded-xl border border-amber-200">
            <h4 className="font-bold text-amber-800 mb-2">Zoönotische infecties</h4>
            <p className="text-amber-700 text-sm m-0">
      ...
      <section id="ziektebeloop" className="scroll-mt-24 mb-12">
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          <div className="overflow-x-auto">
            <table className="w-full text-sm border-collapse">
              ...
              <tbody>
                ...
                <tr><td className="border border-slate-200 pl-3 py-2"><strong>Persistent progressief</strong></td><td className="border border-slate-200 pl-3 py-2">Zonder behandeling progressie naar ernstige ziekte</td><td className="border border-slate-200 pl-3 py-2">HIV → AIDS (opportunistische infecties)</td></tr>
          ...
          <div className="p-5 bg-primary-50 rounded-xl border border-primary-200">
            ...
            <p className="text-primary-700 text-sm mb-2">
              HHV-1 (HSV-1), HHV-2 (HSV-2), HHV-3 (VZV), HHV-4 (EBV), HHV-5 (CMV), HHV-6/7 (roseolovirus), HHV-8 (Kaposi-sarcoom). Patroon: primaire infectie → latentie → reactivatie. Risico op reactivatie hangt af van mate van immunocompromittering: HSV-1/2 snel; VZV, EBV, CMV bij meer immunosuppressie; HHV-6, HHV-8 bij ernstige immunosuppressie (stamceltransplantatie, eindstadium AIDS).
            </p>
            <p className="text-primary-700 text-sm m-0">
              <strong>VZV:</strong> primaire infectie = waterpokken; reactivatie = gordelroos (herpes zoster). Bij immuuncompetenten vaak één dermatoom; bij immuungecompromitteerden meerdere dermatomen of systemisch.
            </p>
          </div>
          ...
          <div className="p-5 bg-teal-50 rounded-xl border border-teal-200">
            ...
            <p className="text-teal-700 text-sm m-0">
              <strong>Lokaal:</strong> infectie op plaats van binnenkomst (bijv. rinovirus → rhinitis). <strong>Systemisch:</strong> replicatie op binnenkomstplaats, daarna verspreiding via bloed/lymfe/CZS (bijv. hepatitis A: darm → lever → hepatitis).
            </p>
          </div>
        </div>
      </section>
      ...
      <section id="pathogenese" className="scroll-mt-24 mb-12">
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          ...
          <div className="p-5 bg-primary-50 rounded-xl border border-primary-200">
            ...
            <p className="text-primary-700 text-sm m-0">
              Lysis van gastheercellen door intracellulaire virusreplicatie. Voorbeelden: influenza A (degeneratie respiratoir epitheel); poliovirus (destructie motorneuronen); rotavirus (infectie mature enterocyten → diarree); HSV (lytische replicatie in epitheel). Mazelenvirus: syncytia-formatie (multinucleaire reuzencellen). CMV: intranucleaire inclusielichaampjes ("uilenogen").
            </p>
          </div>
          ...
          <div className="p-5 bg-teal-50 rounded-xl border border-teal-200">
            ...
            <p className="text-teal-700 text-sm mb-2">
              <strong>Cytokinestorm:</strong> IL-6, IP-10, IFNγ, TNF; levensbedreigend, multi-orgaanfalen; bij ernstige SARS-CoV-2. Behandeling: dexamethason, IL-6-remmers.
            </p>
            <p className="text-teal-700 text-sm m-0">
              <strong>Immuuncomplexen:</strong> antilichaam-antigeen complexen → neerslag in vaatwand, huid, nier → weefselschade. Voorbeeld: polyarteritis nodosa of glomerulonefritis bij hepatitis B (HBsAg-anti-HBs).
            </p>
          </div>
          ...
          <div className="p-5 bg-amber-50 rounded-xl border border-amber-200">
            ...
            <p className="text-amber-700 text-sm m-0">
              Virussen verstoren regulatie celdeling → kanker. HPV (belangrijkste oorzaak cervixcarcinoom), EBV (Burkitt-lymfoom, nasofaryngeaal carcinoom), HBV/HCV (hepatocellulair carcinoom), HHV-8 (Kaposi-sarcoom, vooral bij AIDS), HTLV-1 (adult T-cel leukemie).
            </p>
          </div>
        </div>
      </section>
      ...
      <section id="ziektebeeld" className="scroll-mt-24 mb-12">
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          <div className="overflow-x-auto">
            <table className="w-full text-sm border-collapse">
              ...
              <tbody>
                ...
                <tr><td className="border border-slate-200 pl-3 py-2"><strong>Ooginfecties</strong></td><td className="border border-slate-200 pl-3 py-2">Virale conjunctivitis: 50–60% adenovirus</td></tr>
          ...
          <div className="p-5 bg-indigo-50 rounded-xl border border-indigo-200">
            ...
            <p className="text-indigo-700 text-sm m-0">
              Polio- en non-polio enterovirussen. Breed tropisme → vele ziektebeelden: neonatale sepsis, conjunctivitis, hepatitis, myocarditis, hand-voet-mondziekte, respiratoire klachten, neurologische verschijnselen. Voorbeelden: poliovirus, coxsackievirus, ECHO-virus, enterovirus 71.
            </p>
          </div>
        </div>
      </section>
      ...
      <section id="samenvatting" className="scroll-mt-24 mb-12">
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          <ul className="list-disc pl-6 space-y-2">
            <li>Transmissieroutes, incubatietijd en besmettelijke periode variëren per virus.</li>
    ...
    >
      ...
      <section id="aanvraag" className="scroll-mt-24 mb-12">
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          ...
          <div className="p-5 bg-primary-50 rounded-xl border border-primary-200">
            <h4 className="font-bold text-primary-800 mb-2">Patiëntidentificatie en klinische gegevens</h4>
            <p className="text-primary-700 text-sm mb-2">
              <strong>Verplicht:</strong> naam, geboortedatum, patiëntnummer op zowel aanvraag als materiaal. Aanvragergegevens voor terugkoppeling en contact door arts-microbioloog.
            </p>
            <p className="text-primary-700 text-sm m-0">
          ...
          <div className="p-5 bg-teal-50 rounded-xl border border-teal-200">
            ...
            <p className="text-teal-700 text-sm m-0">
              Correct registreren voor juiste weergave in uitslag en volgorde van vervolgmonsters. Relatie afnamedatum–ziekteduur bepaalt betrouwbaarheid en interpretatie. Suboptimale bewaarcondities kunnen kwaliteit aantasten.
            </p>
          </div>
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm border-collapse">
              ...
              <tbody>
                <tr><td className="border border-slate-200 pl-3 py-2"><strong>Bloed/serum</strong></td><td className="border border-slate-200 pl-3 py-2">Stolbloed (geel); EDTA (paars); Heparine (groen) – <strong>niet voor PCR/NAAT</strong> (heparine remt PCR → fout-negatief)</td></tr>
                ...
                <tr><td className="border border-slate-200 pl-3 py-2"><strong>Faeces</strong></td><td className="border border-slate-200 pl-3 py-2">2–5 g/ml in steriel potje; indicaties: diarree, acute slappe verlamming, myocarditis</td></tr>
          ...
          <div className="p-5 bg-amber-50 rounded-xl border border-amber-200">
            ...
            <p className="text-amber-700 text-sm m-0">
              <strong>Virus transport medium (VTM):</strong> optimale pH, antibiotica tegen bacteriegroei. Virussen kunnen geïnactiveerd worden door zonlicht, hitte, pH-wisselingen. Virale genoom: gevoelig voor nucleasen, dehydratie, hitte. Zo kort mogelijk tussen afname en test. Onbekende virussen → altijd veiligheidsmaatregelen.
            </p>
          </div>
        </div>
      </section>
      ...
      <section id="serologie" className="scroll-mt-24 mb-12">
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          ...
          <div className="p-5 bg-primary-50 rounded-xl border border-primary-200">
            ...
            <p className="text-primary-700 text-sm mb-2">
              <strong>IgM:</strong> eerste respons; duidt op recente infectie (ezelsbrug: M = momenteel). <strong>IgG:</strong> later, vaak levenslang (ezelsbrug: G = geweest). Isotype-switch na enkele dagen. Vervolgserum 2–3 weken na acute fase voor dynamiek.
            </p>
            <p className="text-primary-700 text-sm m-0">
          ...
          <div className="p-5 bg-teal-50 rounded-xl border border-teal-200">
            ...
            <p className="text-teal-700 text-sm m-0">
              <strong>Antilichaamdetectie:</strong> antigeen gecoat op plaat → serum → enzymgekoppeld secundair antilichaam → substraat → kleur. Titer = hoogste verdunning nog positief. <strong>Antigeendetectie:</strong> capture-antilichaam → patiëntmateriaal → detectie-antilichaam met enzym. CLIA: geautomatiseerd, hoog volume.
            </p>
          </div>
          ...
          <div className="p-5 bg-amber-50 rounded-xl border border-amber-200">
            ...
            <p className="text-amber-700 text-sm m-0">
              <strong>CMV:</strong> IgM + IgG; bij verdenking infectie &gt;3–4 maanden: aviditytest (hoge avidity = infectie ≥3–4 maanden geleden). <strong>HIV:</strong> combotest (p24 + antistoffen); positieve screening → bevestigingstest.
            </p>
          </div>
        </div>
      </section>
      ...
      <section id="moleculair" className="scroll-mt-24 mb-12">
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          <p>
            <strong>PCR</strong> (polymerasekettingreactie): vermenigvuldigt DNA-fragment; 30 cycli ≈ 2³⁰ kopieën. Detectie: agarosegel of real-time met fluorescentie. <strong>RNA-virussen:</strong> eerst reverse transcriptase (RNA → cDNA) → RT-PCR.
          </p>
          
          <div className="p-5 bg-primary-50 rounded-xl border border-primary-200">
            <h4 className="font-bold text-primary-800 mb-2">Ct-waarde (cycle threshold)</h4>
            <p className="text-primary-700 text-sm m-0">
              Aantal cycli nodig om fluorescentiesignaal boven achtergrond te detecteren. <strong>Lage Ct</strong> = hoge virale load. <strong>Hoge Ct</strong> = lage virale load. Met standaard: kwantificatie in kopieën of IU mogelijk.
            </p>
          </div>
          ...
          <div className="p-5 bg-amber-50 rounded-xl border border-amber-200">
            ...
            <p className="text-amber-700 text-sm m-0">
              TMA, LAMP, CRISPR. Moleculaire sneltesten: 1–2 uur; sample direct in cartridge; multiplex (influenza A/B, RSV, SARS-CoV-2); syndroompanels (&gt;10 targets) voor gastro-enteritis, luchtwegen, meningitis.
            </p>
          </div>
      ...
      <section id="samenvatting" className="scroll-mt-24 mb-12">
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          <ul className="list-disc pl-6 space-y-2">
            <li>Aanvraag: volledige patiëntidentificatie, klinische gegevens, afnamedatum; per materiaalsoort aparte aanvraag.</li>
