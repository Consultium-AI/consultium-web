export default function Sect13AandachtIPEX() {
  return (
    <div className="space-y-4 text-slate-700 dark:text-slate-300 leading-relaxed">
      <div className="rounded-xl border border-orange-200 dark:border-orange-700/50 bg-orange-50/90 dark:bg-orange-950/45 p-5 space-y-3">
        ...
        <p>Waarom past IPEX goed bij het onderwerp tolerantie?</p>
        <p className="font-semibold text-slate-900 dark:text-slate-100">Mini-antwoord</p>
        <p>
          Omdat een FOXP3-mutatie leidt tot uitval van Treg-cellen, en dus tot verlies van perifere suppressie en het ontstaan
          van auto-immuniteit.
        </p>
      </div>
    </div>
