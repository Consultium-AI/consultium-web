...
const Image01IntroductieSummary = () => {
  ...
  return (
    <SummaryLayout
      title="Introductie – Scabiës"
      description="Leerdoelen, doelgroep en inhoud van de module over scabiës als huidmanifestatie van een infectieziekte."
      caseLabel="Week 5 Casus 7 LME 2: Afbeelding 1"
      tableOfContents={tableOfContents}
      practiceLink="/oefenvragen?lme=lme2-scabies-image01"
    >
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          <div className="p-5 bg-primary-50 rounded-xl border border-primary-200">
            ...
            <ul className="list-disc pl-6 space-y-1 text-primary-700 text-sm">
              <li>Scabiës symptomen te herkennen</li>
              <li>De diagnose scabies te kunnen stellen</li>
              <li>De drie behandelpijlers uit te voeren</li>
            </ul>
          </div>
          ...
          <div className="p-5 bg-amber-50 rounded-xl border border-amber-200">
            ...
            <ul className="list-disc pl-6 space-y-1 text-amber-700 text-sm">
              <li>Hoofdstuk 1: Scabiës etiologie, pathogenese en transmissie</li>
              <li>Hoofdstuk 2: Scabiës diagnostiek</li>
              <li>Hoofdstuk 3: Scabiës behandeling</li>
            </ul>
          </div>
          
          <p className="text-slate-600 text-sm">
            Het doornemen van deze module kost ongeveer 45 minuten.
          </p>
        </div>
      </section>
    </SummaryLayout>
