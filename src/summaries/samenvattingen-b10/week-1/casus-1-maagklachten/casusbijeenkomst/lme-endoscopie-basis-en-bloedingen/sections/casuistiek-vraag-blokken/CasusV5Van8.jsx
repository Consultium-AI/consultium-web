export default function CasusV5Van8() {
  return (
    <article className="rounded-2xl border border-slate-200/95 dark:border-slate-700/90 bg-white/90 dark:bg-slate-900/45 p-5 shadow-md dark:shadow-black/35 space-y-4">
      <p className="text-xs uppercase tracking-wide text-slate-500 dark:text-slate-400">Vraag 5 van 8</p>
      <h3 className="text-lg font-bold text-slate-900 dark:text-slate-50">Casus 3</h3>
      <p className="text-slate-800 dark:text-slate-100">
        Een 62-jarige patiënt met levercirrose en bekend alcoholgebruik presenteert zich met hematemesis (braken van bloed). Hij is hemodynamisch instabiel (lage bloeddruk, tachycardie).
      </p>
      ...
      <ul className="space-y-2">
        ...
        <li className="rounded-lg px-4 py-2 border border-rose-500/45 bg-rose-50 dark:bg-rose-950/35">Alleen een longbloeding</li>
      </ul>
      <div className="border-t border-slate-100 dark:border-slate-700/80 pt-4 space-y-2">
        ...
        <p>
          Hematemesis wijst vrijwel altijd op een bloeding hoog in het GI-stelsel. In combinatie met levercirrose is de kans groot op een varicesbloeding (slokdarmvarices door portale hypertensie).
        </p>
