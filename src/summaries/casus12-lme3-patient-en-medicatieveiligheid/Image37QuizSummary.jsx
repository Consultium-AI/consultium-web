...
const Image37QuizSummary = () => {
  ...
  return (
    <SummaryLayout
      ...
      caseLabel="Week 6 Casus 12 LME 3: Afbeelding 37"
      tableOfContents={toc}
      practiceLink="/oefenvragen?lme=casus12-lme3-patient-en-medicatieveiligheid-image37"
    >
...
export default Image37QuizSummary
